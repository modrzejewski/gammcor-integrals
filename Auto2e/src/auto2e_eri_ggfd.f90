...
! Angular momenta: A=4, B=4, C=3, and D=2
!
...
subroutine auto2e_eri_4_4_3_2(G, Ra, CntrA, ExpA, NprimA, &
Rb, CntrB, ExpB, NprimB, Rc, CntrC, ExpC, NprimC, &
Rd, CntrD, ExpD, NprimD, Kappa)
!
! Two-electron integrals class: (gg|fd)
...
real(F64), dimension(145, 46) :: W
!
! Compute (LS|KS) integrals, L=4..8 and K=3..5
!
W = ZERO
...
call auto2e_W_8_5(W, Ra, CntrA, ExpA, NprimA, Rb, CntrB, ExpB, NprimB, &
   Rc, CntrC, ExpC, NprimC, Rd, CntrD, ExpD, NprimD, Kappa, 101, 26)
call auto2e_BraKetTransfer_4_4_3_2(G, W, Ra, Rb, Rc, Rd)
end subroutine auto2e_eri_4_4_3_2

subroutine auto2e_eri_Spher_4_4_3_2(G, Ra, CntrA, ExpA, NprimA, &
Rb, CntrB, ExpB, NprimB, Rc, CntrC, ExpC, NprimC, &
Rd, CntrD, ExpD, NprimD, Kappa)
!
! Two-electron integrals class: (gg|fd)
...
call auto2e_W_8_5(W, Ra, CntrA, ExpA, NprimA, Rb, CntrB, ExpB, NprimB, &
   Rc, CntrC, ExpC, NprimC, Rd, CntrD, ExpD, NprimD, Kappa, 101, 26)
call auto2e_BraKetTransfer_Spher_4_4_3_2(G, W, Ra, Rb, Rc, Rd)
end subroutine auto2e_eri_Spher_4_4_3_2

subroutine auto2e_BraKetTransfer_4_4_3_2(G, W, Ra, Rb, Rc, Rd)
!
! Transform (LS|KS), L=4..8, K=3..5 using the horizontal recurrence relation
...
real(F64), dimension(145, 46), intent(in) :: W
real(F64), dimension(3), intent(in) :: Ra, Rb, Rc, Rd
real(F64), dimension(3) :: AB, CD
real(F64), dimension(145, 60) :: T
real(F64), dimension(60, 145) :: U
AB = Ra - Rb
CD = Rc - Rd
call auto2e_KetTransfer_3_2(T, W, CD(1), CD(2), CD(3))
U = transpose(T)
call auto2e_KetTransfer_4_4(G(:, 1:225), U, AB(1), AB(2), AB(3))
end subroutine auto2e_BraKetTransfer_4_4_3_2

subroutine auto2e_BraKetTransfer_Spher_4_4_3_2(G, W, Ra, Rb, Rc, Rd)
!
! Transform (LS|KS), L=4..8, K=3..5 using the horizontal recurrence relation
! of Eq. 18 in Head-Gordon, M. and Pople, J.A. J. Chem. Phys. 89, 5777 (1988);
! doi: 10.1063/1.455553
...
real(F64), dimension(3), intent(in) :: Ra, Rb, Rc, Rd
real(F64), dimension(3) :: AB, CD
real(F64), dimension(145, 60) :: Txyz
real(F64), dimension(145, 35) :: T
real(F64), dimension(35, 145) :: U
real(F64), dimension(35, 225) :: Gxyz
AB = Ra - Rb
CD = Rc - Rd
call auto2e_KetTransfer_3_2(Txyz, W, CD(1), CD(2), CD(3))
call auto2e_SpherTransf_U_Vector_3_2(T, Txyz, 145)
U = transpose(T)
call auto2e_KetTransfer_4_4(Gxyz, U, AB(1), AB(2), AB(3))
call auto2e_SpherTransf_U_Vector_4_4(G(:, 1:81), Gxyz, 35)
end subroutine auto2e_BraKetTransfer_Spher_4_4_3_2

subroutine auto2e_Normalize_4_4_3_2_BACD(Gbacd, Gcdab, NormA, NormB, NormC, NormD)
!
...
end subroutine auto2e_Normalize_4_4_3_2_BACD

subroutine auto2e_Normalize_4_4_3_2_BADC(Gbadc, Gcdab, NormA, NormB, NormC, NormD)
!
! Apply L-dependent normalization constants and change the memory layout:
!
! Input memory layout: CDAB
...
end subroutine auto2e_Normalize_4_4_3_2_BADC

subroutine auto2e_Normalize_4_4_3_2_CDBA(Gcdba, Gcdab, NormA, NormB, NormC, NormD)
!
! Apply L-dependent normalization constants and change the memory layout:
!
! Input memory layout: CDAB
...
end subroutine auto2e_Normalize_4_4_3_2_CDBA

subroutine auto2e_Normalize_4_4_3_2_DCBA(Gdcba, Gcdab, NormA, NormB, NormC, NormD)
!
! Apply L-dependent normalization constants and change the memory layout:
!
! Input memory layout: CDAB
...
end subroutine auto2e_Normalize_4_4_3_2_DCBA

subroutine auto2e_Normalize_Spher_4_4_3_2_BACD(Gbacd, Gcdab, NormA, NormB, NormC, NormD)
!
! Apply L-dependent normalization constants and change the memory layout:
!
! Input memory layout: CDAB
...
end subroutine auto2e_Normalize_Spher_4_4_3_2_BACD

subroutine auto2e_Normalize_Spher_4_4_3_2_BADC(Gbadc, Gcdab, NormA, NormB, NormC, NormD)
!
! Apply L-dependent normalization constants and change the memory layout:
!
! Input memory layout: CDAB
...
end subroutine auto2e_Normalize_Spher_4_4_3_2_BADC

subroutine auto2e_Normalize_Spher_4_4_3_2_CDBA(Gcdba, Gcdab, NormA, NormB, NormC, NormD)
!
! Apply L-dependent normalization constants and change the memory layout:
!
! Input memory layout: CDAB
...
end subroutine auto2e_Normalize_Spher_4_4_3_2_CDBA

subroutine auto2e_Normalize_Spher_4_4_3_2_DCBA(Gdcba, Gcdab, NormA, NormB, NormC, NormD)
!
! Apply L-dependent normalization constants and change the memory layout:
!
! Input memory layout: CDAB
...
end subroutine auto2e_Normalize_Spher_4_4_3_2_DCBA

subroutine auto2e_frontend_4_4_2_3(G, Ra, CntrA, NormA, ExpA, NprimA, &
...
call auto2e_eri_4_4_3_2(H, Ra, CntrA, ExpA, NprimA, &
   Rb, CntrB, ExpB, NprimB, &
   Rd, CntrD, ExpD, NprimD, &
   Rc, CntrC, ExpC, NprimC, Kappa)
call auto2e_Normalize_4_4_3_2_CDBA(G, H, NormA, NormB, NormD, NormC)
end subroutine auto2e_frontend_4_4_2_3

subroutine auto2e_frontend_Spher_4_4_2_3(G, Ra, CntrA, NormA, ExpA, NprimA, &
Rb, CntrB, NormB, ExpB, NprimB, Rc, CntrC, NormC, ExpC, NprimC, &
Rd, CntrD, NormD, ExpD, NprimD, Kappa)
real(F64), dimension(*), intent(out) :: G
real(F64), dimension(3), intent(in) :: Ra, Rb, Rc, Rd
...
call auto2e_eri_Spher_4_4_3_2(H, Ra, CntrA, ExpA, NprimA, &
   Rb, CntrB, ExpB, NprimB, &
   Rd, CntrD, ExpD, NprimD, &
   Rc, CntrC, ExpC, NprimC, Kappa)
call auto2e_Normalize_Spher_4_4_3_2_CDBA(G, H, NormA, NormB, NormD, NormC)
end subroutine auto2e_frontend_Spher_4_4_2_3

subroutine auto2e_frontend_4_4_3_2(G, Ra, CntrA, NormA, ExpA, NprimA, &
Rb, CntrB, NormB, ExpB, NprimB, Rc, CntrC, NormC, ExpC, NprimC, &
Rd, CntrD, NormD, ExpD, NprimD, Kappa)
real(F64), dimension(*), intent(out) :: G
real(F64), dimension(3), intent(in) :: Ra, Rb, Rc, Rd
...
call auto2e_eri_4_4_3_2(H, Ra, CntrA, ExpA, NprimA, &
   ...
   Rd, CntrD, ExpD, NprimD, Kappa)
call auto2e_Normalize_4_4_3_2_DCBA(G, H, NormA, NormB, NormC, NormD)
end subroutine auto2e_frontend_4_4_3_2

subroutine auto2e_frontend_Spher_4_4_3_2(G, Ra, CntrA, NormA, ExpA, NprimA, &
Rb, CntrB, NormB, ExpB, NprimB, Rc, CntrC, NormC, ExpC, NprimC, &
Rd, CntrD, NormD, ExpD, NprimD, Kappa)
real(F64), dimension(*), intent(out) :: G
real(F64), dimension(3), intent(in) :: Ra, Rb, Rc, Rd
...
call auto2e_eri_Spher_4_4_3_2(H, Ra, CntrA, ExpA, NprimA, &
   ...
   Rc, CntrC, ExpC, NprimC, &
   Rd, CntrD, ExpD, NprimD, Kappa)
call auto2e_Normalize_Spher_4_4_3_2_DCBA(G, H, NormA, NormB, NormC, NormD)
end subroutine auto2e_frontend_Spher_4_4_3_2

subroutine auto2e_frontend_2_3_4_4(G, Ra, CntrA, NormA, ExpA, NprimA, &
Rb, CntrB, NormB, ExpB, NprimB, Rc, CntrC, NormC, ExpC, NprimC, &
Rd, CntrD, NormD, ExpD, NprimD, Kappa)
real(F64), dimension(*), intent(out) :: G
real(F64), dimension(3), intent(in) :: Ra, Rb, Rc, Rd
...
real(F64), intent(in) :: Kappa
real(F64), dimension(13500) :: H
call auto2e_eri_4_4_3_2(H, Rc, CntrC, ExpC, NprimC, &
   Rd, CntrD, ExpD, NprimD, &
   Rb, CntrB, ExpB, NprimB, &
   Ra, CntrA, ExpA, NprimA, Kappa)
call auto2e_Normalize_4_4_3_2_BACD(G, H, NormC, NormD, NormB, NormA)
end subroutine auto2e_frontend_2_3_4_4

subroutine auto2e_frontend_Spher_2_3_4_4(G, Ra, CntrA, NormA, ExpA, NprimA, &
Rb, CntrB, NormB, ExpB, NprimB, Rc, CntrC, NormC, ExpC, NprimC, &
Rd, CntrD, NormD, ExpD, NprimD, Kappa)
real(F64), dimension(*), intent(out) :: G
real(F64), dimension(3), intent(in) :: Ra, Rb, Rc, Rd
...
real(F64), intent(in) :: Kappa
real(F64), dimension(2835) :: H
call auto2e_eri_Spher_4_4_3_2(H, Rc, CntrC, ExpC, NprimC, &
   Rd, CntrD, ExpD, NprimD, &
   Rb, CntrB, ExpB, NprimB, &
   Ra, CntrA, ExpA, NprimA, Kappa)
call auto2e_Normalize_Spher_4_4_3_2_BACD(G, H, NormC, NormD, NormB, NormA)
end subroutine auto2e_frontend_Spher_2_3_4_4

subroutine auto2e_frontend_3_2_4_4(G, Ra, CntrA, NormA, ExpA, NprimA, &
Rb, CntrB, NormB, ExpB, NprimB, Rc, CntrC, NormC, ExpC, NprimC, &
Rd, CntrD, NormD, ExpD, NprimD, Kappa)
real(F64), dimension(*), intent(out) :: G
real(F64), dimension(3), intent(in) :: Ra, Rb, Rc, Rd
...
call auto2e_Normalize_4_4_3_2_BADC(G, H, NormC, NormD, NormA, NormB)
end subroutine auto2e_frontend_3_2_4_4

subroutine auto2e_frontend_Spher_3_2_4_4(G, Ra, CntrA, NormA, ExpA, NprimA, &
Rb, CntrB, NormB, ExpB, NprimB, Rc, CntrC, NormC, ExpC, NprimC, &
Rd, CntrD, NormD, ExpD, NprimD, Kappa)
real(F64), dimension(*), intent(out) :: G
real(F64), dimension(3), intent(in) :: Ra, Rb, Rc, Rd
...
call auto2e_eri_Spher_4_4_3_2(H, Rc, CntrC, ExpC, NprimC, &
   ...
   Ra, CntrA, ExpA, NprimA, &
   Rb, CntrB, ExpB, NprimB, Kappa)
call auto2e_Normalize_Spher_4_4_3_2_BADC(G, H, NormC, NormD, NormA, NormB)
end subroutine auto2e_frontend_Spher_3_2_4_4
end module auto2e_eri_ggfd