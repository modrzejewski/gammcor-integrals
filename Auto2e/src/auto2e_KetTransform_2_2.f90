...
S(1:3) = Ey(1)*Ez(1)*(Ex(4)*R(1:3) - Ex(5)*R(2:4) + Ex(6)*R(3:5))
S(4:5) = Ey(1)*Ez(1)*(Ex(4)*R(6:7) - Ex(5)*R(7:8) + Ex(6)*R(8:9))
S(6) = Ey(1)*Ez(1)*(Ex(4)*R(10) - Ex(5)*R(11) + Ex(6)*R(12))
S(7:8) = Ey(1)*Ez(1)*(Ex(4)*R(16:17) - Ex(5)*R(17:18) + Ex(6)*R(18:19))
S(9) = Ey(1)*Ez(1)*(Ex(4)*R(20) - Ex(5)*R(21) + Ex(6)*R(22))
S(10) = Ey(1)*Ez(1)*(Ex(4)*R(26) - Ex(5)*R(27) + Ex(6)*R(28))
...
real(F64), dimension(:), intent(in) :: Ez
real(F64), dimension(:), intent(in) :: R
S(1:3) = Ey(2)*Ez(1)*(Ex(2)*R(1:3) - Ex(3)*R(2:4)) + Ey(3)*Ez(1)*(-Ex(2)*R(6:8)  &
   + Ex(3)*R(7:9))
S(4:5) = Ey(2)*Ez(1)*(Ex(2)*R(6:7) - Ex(3)*R(7:8)) + Ey(3)*Ez(1)*(-Ex(2)*R(10:11)  &
   + Ex(3)*R(11:12))
S(6) = Ey(2)*Ez(1)*(Ex(2)*R(10) - Ex(3)*R(11)) + Ey(3)*Ez(1)*(-Ex(2)*R(13) + Ex(3) &
   *R(14))
S(7:8) = Ey(2)*Ez(1)*(Ex(2)*R(16:17) - Ex(3)*R(17:18)) + Ey(3)*Ez(1)*(-Ex(2)*R(20:21)  &
   + Ex(3)*R(21:22))
S(9) = Ey(2)*Ez(1)*(Ex(2)*R(20) - Ex(3)*R(21)) + Ey(3)*Ez(1)*(-Ex(2)*R(23) + Ex(3) &
   *R(24))
S(10) = Ey(2)*Ez(1)*(Ex(2)*R(26) - Ex(3)*R(27)) + Ey(3)*Ez(1)*(-Ex(2)*R(29) + Ex(3) &
   *R(30))
...
real(F64), dimension(:), intent(in) :: Ez
real(F64), dimension(:), intent(in) :: R
S(1:3) = Ey(1)*Ex(1)*(Ez(4)*R(1:3) - Ez(5)*R(16:18) + Ez(6)*R(26:28))
S(4:5) = Ey(1)*Ex(1)*(Ez(4)*R(6:7) - Ez(5)*R(20:21) + Ez(6)*R(29:30))
S(6) = Ey(1)*Ex(1)*(Ez(4)*R(10) - Ez(5)*R(23) + Ez(6)*R(31))
S(7:8) = Ey(1)*Ex(1)*(Ez(4)*R(16:17) - Ez(5)*R(26:27) + Ez(6)*R(32:33))
S(9) = Ey(1)*Ex(1)*(Ez(4)*R(20) - Ez(5)*R(29) + Ez(6)*R(34))
S(10) = Ey(1)*Ex(1)*(Ez(4)*R(26) - Ez(5)*R(32) + Ez(6)*R(35))
