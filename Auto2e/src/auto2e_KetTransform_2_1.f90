...
S(1:3) = Ey(1)*Ez(1)*(Ex(2)*R(1:3) - Ex(3)*R(2:4))
S(4:5) = Ey(1)*Ez(1)*(Ex(2)*R(5:6) - Ex(3)*R(6:7))
S(6) = Ey(1)*Ez(1)*(Ex(2)*R(8) - Ex(3)*R(9))
S(7:8) = Ey(1)*Ez(1)*(Ex(2)*R(11:12) - Ex(3)*R(12:13))
S(9) = Ey(1)*Ez(1)*(Ex(2)*R(14) - Ex(3)*R(15))
S(10) = Ey(1)*Ez(1)*(Ex(2)*R(17) - Ex(3)*R(18))
...
real(F64), dimension(:), intent(in) :: Ez
real(F64), dimension(:), intent(in) :: R
S(1:3) = Ex(1)*Ez(1)*(Ey(2)*R(1:3) - Ey(3)*R(5:7))
S(4:5) = Ex(1)*Ez(1)*(Ey(2)*R(5:6) - Ey(3)*R(8:9))
S(6) = Ex(1)*Ez(1)*(Ey(2)*R(8) - Ey(3)*R(10))
S(7:8) = Ex(1)*Ez(1)*(Ey(2)*R(11:12) - Ey(3)*R(14:15))
S(9) = Ex(1)*Ez(1)*(Ey(2)*R(14) - Ey(3)*R(16))
S(10) = Ex(1)*Ez(1)*(Ey(2)*R(17) - Ey(3)*R(19))
...
real(F64), dimension(:), intent(in) :: Ez
real(F64), dimension(:), intent(in) :: R
S(1:3) = Ey(1)*Ex(1)*(Ez(2)*R(1:3) - Ez(3)*R(11:13))
S(4:5) = Ey(1)*Ex(1)*(Ez(2)*R(5:6) - Ez(3)*R(14:15))
S(6) = Ey(1)*Ex(1)*(Ez(2)*R(8) - Ez(3)*R(16))
S(7:8) = Ey(1)*Ex(1)*(Ez(2)*R(11:12) - Ez(3)*R(17:18))
S(9) = Ey(1)*Ex(1)*(Ez(2)*R(14) - Ez(3)*R(19))
S(10) = Ey(1)*Ex(1)*(Ez(2)*R(17) - Ez(3)*R(20))
