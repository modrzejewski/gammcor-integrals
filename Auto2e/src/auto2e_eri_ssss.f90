...
! Angular momenta: A=0, B=0, C=0, and D=0
!
...
subroutine auto2e_eri_0_0_0_0(G, Ra, CntrA, ExpA, NprimA, &
Rb, CntrB, ExpB, NprimB, Rc, CntrC, ExpC, NprimC, &
Rd, CntrD, ExpD, NprimD, Kappa)
!
! Two-electron integrals class: (ss|ss)
...
G(1:1, 1:1) = ZERO
call auto2e_W_0_0(G(1:1, 1:1), Ra, CntrA, ExpA, NprimA, Rb, CntrB, ExpB, NprimB, &
Rc, CntrC, ExpC, NprimC, Rd, CntrD, ExpD, NprimD, Kappa, 1, 1)
end subroutine auto2e_eri_0_0_0_0



subroutine auto2e_Normalize_0_0_0_0_ABCD(G, NormA, NormB, NormC, NormD)
!
...
end subroutine auto2e_Normalize_0_0_0_0_ABCD

subroutine auto2e_frontend_0_0_0_0(G, Ra, CntrA, NormA, ExpA, NprimA, &
...
integer, intent(in) :: NprimA, NprimB, NprimC, NprimD
real(F64), intent(in) :: Kappa
call auto2e_eri_0_0_0_0(G, Ra, CntrA, ExpA, NprimA, &
   Rb, CntrB, ExpB, NprimB, &
   Rc, CntrC, ExpC, NprimC, &
   Rd, CntrD, ExpD, NprimD, Kappa)
call auto2e_Normalize_0_0_0_0_ABCD(G, NormA, NormB, NormC, NormD)
end subroutine auto2e_frontend_0_0_0_0
end module auto2e_eri_ssss