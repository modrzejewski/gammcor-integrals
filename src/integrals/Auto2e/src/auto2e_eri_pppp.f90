...
! Angular momenta: A=1, B=1, C=1, and D=1
!
...
subroutine auto2e_eri_1_1_1_1(G, Ra, CntrA, ExpA, NprimA, &
Rb, CntrB, ExpB, NprimB, Rc, CntrC, ExpC, NprimC, &
Rd, CntrD, ExpD, NprimD, Kappa)
!
! Two-electron integrals class: (pp|pp)
...
real(F64), dimension(9, 9) :: W
!
! Compute (LS|KS) integrals, L=1..2 and K=1..2
!
W = ZERO
...
call auto2e_W_1_2(W, Ra, CntrA, ExpA, NprimA, Rb, CntrB, ExpB, NprimB, &
   Rc, CntrC, ExpC, NprimC, Rd, CntrD, ExpD, NprimD, Kappa, 1, 4)
call auto2e_W_2_2(W, Ra, CntrA, ExpA, NprimA, Rb, CntrB, ExpB, NprimB, &
   Rc, CntrC, ExpC, NprimC, Rd, CntrD, ExpD, NprimD, Kappa, 4, 4)
call auto2e_BraKetTransfer_1_1_1_1(G, W, Ra, Rb, Rc, Rd)
end subroutine auto2e_eri_1_1_1_1

subroutine auto2e_BraKetTransfer_1_1_1_1(G, W, Ra, Rb, Rc, Rd)
!
! Transform (LS|KS), L=1..2, K=1..2 using the horizontal recurrence relation
...
!
real(F64), dimension(9, *), intent(out) :: G
real(F64), dimension(9, 9), intent(in) :: W
real(F64), dimension(3), intent(in) :: Ra, Rb, Rc, Rd
real(F64), dimension(3) :: AB, CD
real(F64), dimension(9, 9) :: T
real(F64), dimension(9, 9) :: U
AB = Ra - Rb
CD = Rc - Rd
call auto2e_KetTransfer_1_1(T, W, CD(1), CD(2), CD(3))
U = transpose(T)
call auto2e_KetTransfer_1_1(G(:, 1:9), U, AB(1), AB(2), AB(3))
end subroutine auto2e_BraKetTransfer_1_1_1_1

subroutine auto2e_Normalize_1_1_1_1_DCBA(Gdcba, Gcdab, NormA, NormB, NormC, NormD)
!
...
end subroutine auto2e_Normalize_1_1_1_1_DCBA

subroutine auto2e_frontend_1_1_1_1(G, Ra, CntrA, NormA, ExpA, NprimA, &
...
call auto2e_eri_1_1_1_1(H, Ra, CntrA, ExpA, NprimA, &
   Rb, CntrB, ExpB, NprimB, &
   Rc, CntrC, ExpC, NprimC, &
   Rd, CntrD, ExpD, NprimD, Kappa)
call auto2e_Normalize_1_1_1_1_DCBA(G, H, NormA, NormB, NormC, NormD)
end subroutine auto2e_frontend_1_1_1_1
end module auto2e_eri_pppp