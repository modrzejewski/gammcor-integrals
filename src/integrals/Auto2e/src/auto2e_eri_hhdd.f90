...
! Angular momenta: A=5, B=5, C=2, and D=2
!
...
subroutine auto2e_eri_5_5_2_2(G, Ra, CntrA, ExpA, NprimA, &
Rb, CntrB, ExpB, NprimB, Rc, CntrC, ExpC, NprimC, &
Rd, CntrD, ExpD, NprimD, Kappa)
!
! Two-electron integrals class: (hh|dd)
...
real(F64), dimension(251, 31) :: W
!
! Compute (LS|KS) integrals, L=5..10 and K=2..4
!
W = ZERO
...
call auto2e_W_10_4(W, Ra, CntrA, ExpA, NprimA, Rb, CntrB, ExpB, NprimB, &
   Rc, CntrC, ExpC, NprimC, Rd, CntrD, ExpD, NprimD, Kappa, 186, 17)
call auto2e_BraKetTransfer_5_5_2_2(G, W, Ra, Rb, Rc, Rd)
end subroutine auto2e_eri_5_5_2_2

subroutine auto2e_eri_Spher_5_5_2_2(G, Ra, CntrA, ExpA, NprimA, &
Rb, CntrB, ExpB, NprimB, Rc, CntrC, ExpC, NprimC, &
Rd, CntrD, ExpD, NprimD, Kappa)
!
! Two-electron integrals class: (hh|dd)
...
call auto2e_W_10_4(W, Ra, CntrA, ExpA, NprimA, Rb, CntrB, ExpB, NprimB, &
   Rc, CntrC, ExpC, NprimC, Rd, CntrD, ExpD, NprimD, Kappa, 186, 17)
call auto2e_BraKetTransfer_Spher_5_5_2_2(G, W, Ra, Rb, Rc, Rd)
end subroutine auto2e_eri_Spher_5_5_2_2

subroutine auto2e_BraKetTransfer_5_5_2_2(G, W, Ra, Rb, Rc, Rd)
!
! Transform (LS|KS), L=5..10, K=2..4 using the horizontal recurrence relation
...
real(F64), dimension(251, 31), intent(in) :: W
real(F64), dimension(3), intent(in) :: Ra, Rb, Rc, Rd
real(F64), dimension(3) :: AB, CD
real(F64), dimension(251, 36) :: T
real(F64), dimension(36, 251) :: U
AB = Ra - Rb
CD = Rc - Rd
call auto2e_KetTransfer_2_2(T, W, CD(1), CD(2), CD(3))
U = transpose(T)
call auto2e_KetTransfer_5_5(G(:, 1:441), U, AB(1), AB(2), AB(3))
end subroutine auto2e_BraKetTransfer_5_5_2_2

subroutine auto2e_BraKetTransfer_Spher_5_5_2_2(G, W, Ra, Rb, Rc, Rd)
!
! Transform (LS|KS), L=5..10, K=2..4 using the horizontal recurrence relation
! of Eq. 18 in Head-Gordon, M. and Pople, J.A. J. Chem. Phys. 89, 5777 (1988);
! doi: 10.1063/1.455553
...
real(F64), dimension(3), intent(in) :: Ra, Rb, Rc, Rd
real(F64), dimension(3) :: AB, CD
real(F64), dimension(251, 36) :: Txyz
real(F64), dimension(251, 25) :: T
real(F64), dimension(25, 251) :: U
real(F64), dimension(25, 441) :: Gxyz
AB = Ra - Rb
CD = Rc - Rd
call auto2e_KetTransfer_2_2(Txyz, W, CD(1), CD(2), CD(3))
call auto2e_SpherTransf_U_Vector_2_2(T, Txyz, 251)
U = transpose(T)
call auto2e_KetTransfer_5_5(Gxyz, U, AB(1), AB(2), AB(3))
call auto2e_SpherTransf_U_Vector_5_5(G(:, 1:121), Gxyz, 25)
end subroutine auto2e_BraKetTransfer_Spher_5_5_2_2

subroutine auto2e_Normalize_5_5_2_2_BADC(Gbadc, Gcdab, NormA, NormB, NormC, NormD)
!
...
end subroutine auto2e_Normalize_5_5_2_2_BADC

subroutine auto2e_Normalize_5_5_2_2_DCBA(Gdcba, Gcdab, NormA, NormB, NormC, NormD)
!
! Apply L-dependent normalization constants and change the memory layout:
!
! Input memory layout: CDAB
...
end subroutine auto2e_Normalize_5_5_2_2_DCBA

subroutine auto2e_Normalize_Spher_5_5_2_2_BADC(Gbadc, Gcdab, NormA, NormB, NormC, NormD)
!
! Apply L-dependent normalization constants and change the memory layout:
!
! Input memory layout: CDAB
...
end subroutine auto2e_Normalize_Spher_5_5_2_2_BADC

subroutine auto2e_Normalize_Spher_5_5_2_2_DCBA(Gdcba, Gcdab, NormA, NormB, NormC, NormD)
!
! Apply L-dependent normalization constants and change the memory layout:
!
! Input memory layout: CDAB
...
end subroutine auto2e_Normalize_Spher_5_5_2_2_DCBA

subroutine auto2e_frontend_5_5_2_2(G, Ra, CntrA, NormA, ExpA, NprimA, &
...
call auto2e_eri_5_5_2_2(H, Ra, CntrA, ExpA, NprimA, &
   Rb, CntrB, ExpB, NprimB, &
   Rc, CntrC, ExpC, NprimC, &
   Rd, CntrD, ExpD, NprimD, Kappa)
call auto2e_Normalize_5_5_2_2_DCBA(G, H, NormA, NormB, NormC, NormD)
end subroutine auto2e_frontend_5_5_2_2

subroutine auto2e_frontend_Spher_5_5_2_2(G, Ra, CntrA, NormA, ExpA, NprimA, &
Rb, CntrB, NormB, ExpB, NprimB, Rc, CntrC, NormC, ExpC, NprimC, &
Rd, CntrD, NormD, ExpD, NprimD, Kappa)
real(F64), dimension(*), intent(out) :: G
real(F64), dimension(3), intent(in) :: Ra, Rb, Rc, Rd
...
call auto2e_eri_Spher_5_5_2_2(H, Ra, CntrA, ExpA, NprimA, &
   Rb, CntrB, ExpB, NprimB, &
   Rc, CntrC, ExpC, NprimC, &
   Rd, CntrD, ExpD, NprimD, Kappa)
call auto2e_Normalize_Spher_5_5_2_2_DCBA(G, H, NormA, NormB, NormC, NormD)
end subroutine auto2e_frontend_Spher_5_5_2_2

subroutine auto2e_frontend_2_2_5_5(G, Ra, CntrA, NormA, ExpA, NprimA, &
Rb, CntrB, NormB, ExpB, NprimB, Rc, CntrC, NormC, ExpC, NprimC, &
Rd, CntrD, NormD, ExpD, NprimD, Kappa)
real(F64), dimension(*), intent(out) :: G
real(F64), dimension(3), intent(in) :: Ra, Rb, Rc, Rd
...
real(F64), intent(in) :: Kappa
real(F64), dimension(15876) :: H
call auto2e_eri_5_5_2_2(H, Rc, CntrC, ExpC, NprimC, &
   Rd, CntrD, ExpD, NprimD, &
   Ra, CntrA, ExpA, NprimA, &
   Rb, CntrB, ExpB, NprimB, Kappa)
call auto2e_Normalize_5_5_2_2_BADC(G, H, NormC, NormD, NormA, NormB)
end subroutine auto2e_frontend_2_2_5_5

subroutine auto2e_frontend_Spher_2_2_5_5(G, Ra, CntrA, NormA, ExpA, NprimA, &
Rb, CntrB, NormB, ExpB, NprimB, Rc, CntrC, NormC, ExpC, NprimC, &
Rd, CntrD, NormD, ExpD, NprimD, Kappa)
real(F64), dimension(*), intent(out) :: G
real(F64), dimension(3), intent(in) :: Ra, Rb, Rc, Rd
...
real(F64), intent(in) :: Kappa
real(F64), dimension(3025) :: H
call auto2e_eri_Spher_5_5_2_2(H, Rc, CntrC, ExpC, NprimC, &
   Rd, CntrD, ExpD, NprimD, &
   Ra, CntrA, ExpA, NprimA, &
   Rb, CntrB, ExpB, NprimB, Kappa)
call auto2e_Normalize_Spher_5_5_2_2_BADC(G, H, NormC, NormD, NormA, NormB)
end subroutine auto2e_frontend_Spher_2_2_5_5
end module auto2e_eri_hhdd