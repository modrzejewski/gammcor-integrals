...
! Angular momenta: A=4, B=4, C=0, and D=0
!
...
subroutine auto2e_eri_4_4_0_0(G, Ra, CntrA, ExpA, NprimA, &
Rb, CntrB, ExpB, NprimB, Rc, CntrC, ExpC, NprimC, &
Rd, CntrD, ExpD, NprimD, Kappa)
!
! Two-electron integrals class: (gg|ss)
...
real(F64), dimension(145, 1) :: W
!
! Compute (LS|KS) integrals, L=4..8 and K=0..0
!
W = ZERO
...
call auto2e_BraKetTransfer_4_4_0_0(G, W, Ra, Rb)
end subroutine auto2e_eri_4_4_0_0

subroutine auto2e_eri_Spher_4_4_0_0(G, Ra, CntrA, ExpA, NprimA, &
Rb, CntrB, ExpB, NprimB, Rc, CntrC, ExpC, NprimC, &
Rd, CntrD, ExpD, NprimD, Kappa)
!
! Two-electron integrals class: (gg|ss)
...
call auto2e_W_8_0(W, Ra, CntrA, ExpA, NprimA, Rb, CntrB, ExpB, NprimB, &
   Rc, CntrC, ExpC, NprimC, Rd, CntrD, ExpD, NprimD, Kappa, 101, 1)
call auto2e_BraKetTransfer_Spher_4_4_0_0(G, W, Ra, Rb)
end subroutine auto2e_eri_Spher_4_4_0_0

subroutine auto2e_BraKetTransfer_4_4_0_0(G, W, Ra, Rb)
!
! Transform (LS|KS), L=4..8, K=0..0 using the horizontal recurrence relation
...
real(F64), dimension(145, 1), intent(in) :: W
real(F64), dimension(3), intent(in) :: Ra, Rb
real(F64), dimension(3) :: AB
real(F64), dimension(1, 145) :: U
AB = Ra - Rb
U = transpose(W)
call auto2e_KetTransfer_4_4(G(:, 1:225), U, AB(1), AB(2), AB(3))
end subroutine auto2e_BraKetTransfer_4_4_0_0

subroutine auto2e_BraKetTransfer_Spher_4_4_0_0(G, W, Ra, Rb)
!
! Transform (LS|KS), L=4..8, K=0..0 using the horizontal recurrence relation
! of Eq. 18 in Head-Gordon, M. and Pople, J.A. J. Chem. Phys. 89, 5777 (1988);
! doi: 10.1063/1.455553
...
real(F64), dimension(3) :: AB
real(F64), dimension(1, 145) :: U
real(F64), dimension(1, 225) :: Gxyz
AB = Ra - Rb
U = transpose(W)
call auto2e_KetTransfer_4_4(Gxyz, U, AB(1), AB(2), AB(3))
call auto2e_SpherTransf_U_Vector_4_4(G(:, 1:81), Gxyz, 1)
end subroutine auto2e_BraKetTransfer_Spher_4_4_0_0

subroutine auto2e_Normalize_4_4_0_0_BACD(Gbacd, Gabcd, NormA, NormB, NormC, NormD)
!
...
end subroutine auto2e_Normalize_4_4_0_0_BACD

subroutine auto2e_Normalize_Spher_4_4_0_0_BACD(Gbacd, Gabcd, NormA, NormB, NormC, NormD)
!
! Apply L-dependent normalization constants and change the memory layout:
!
! Input memory layout: ABCD
...
end subroutine auto2e_Normalize_Spher_4_4_0_0_BACD

subroutine auto2e_frontend_0_0_4_4(G, Ra, CntrA, NormA, ExpA, NprimA, &
...
call auto2e_eri_4_4_0_0(H, Rc, CntrC, ExpC, NprimC, &
   Rd, CntrD, ExpD, NprimD, &
   Ra, CntrA, ExpA, NprimA, &
   Rb, CntrB, ExpB, NprimB, Kappa)
call auto2e_Normalize_4_4_0_0_BACD(G, H, NormC, NormD, NormA, NormB)
end subroutine auto2e_frontend_0_0_4_4

subroutine auto2e_frontend_Spher_0_0_4_4(G, Ra, CntrA, NormA, ExpA, NprimA, &
Rb, CntrB, NormB, ExpB, NprimB, Rc, CntrC, NormC, ExpC, NprimC, &
Rd, CntrD, NormD, ExpD, NprimD, Kappa)
real(F64), dimension(*), intent(out) :: G
real(F64), dimension(3), intent(in) :: Ra, Rb, Rc, Rd
...
call auto2e_eri_Spher_4_4_0_0(H, Rc, CntrC, ExpC, NprimC, &
   Rd, CntrD, ExpD, NprimD, &
   Ra, CntrA, ExpA, NprimA, &
   Rb, CntrB, ExpB, NprimB, Kappa)
call auto2e_Normalize_Spher_4_4_0_0_BACD(G, H, NormC, NormD, NormA, NormB)
end subroutine auto2e_frontend_Spher_0_0_4_4

subroutine auto2e_frontend_4_4_0_0(G, Ra, CntrA, NormA, ExpA, NprimA, &
Rb, CntrB, NormB, ExpB, NprimB, Rc, CntrC, NormC, ExpC, NprimC, &
Rd, CntrD, NormD, ExpD, NprimD, Kappa)
real(F64), dimension(*), intent(out) :: G
real(F64), dimension(3), intent(in) :: Ra, Rb, Rc, Rd
...
real(F64), intent(in) :: Kappa
real(F64), dimension(225) :: H
call auto2e_eri_4_4_0_0(H, Ra, CntrA, ExpA, NprimA, &
   Rb, CntrB, ExpB, NprimB, &
   Rc, CntrC, ExpC, NprimC, &
   Rd, CntrD, ExpD, NprimD, Kappa)
call auto2e_Normalize_4_4_0_0_BACD(G, H, NormA, NormB, NormC, NormD)
end subroutine auto2e_frontend_4_4_0_0

subroutine auto2e_frontend_Spher_4_4_0_0(G, Ra, CntrA, NormA, ExpA, NprimA, &
Rb, CntrB, NormB, ExpB, NprimB, Rc, CntrC, NormC, ExpC, NprimC, &
Rd, CntrD, NormD, ExpD, NprimD, Kappa)
real(F64), dimension(*), intent(out) :: G
real(F64), dimension(3), intent(in) :: Ra, Rb, Rc, Rd
...
real(F64), intent(in) :: Kappa
real(F64), dimension(81) :: H
call auto2e_eri_Spher_4_4_0_0(H, Ra, CntrA, ExpA, NprimA, &
   Rb, CntrB, ExpB, NprimB, &
   Rc, CntrC, ExpC, NprimC, &
   Rd, CntrD, ExpD, NprimD, Kappa)
call auto2e_Normalize_Spher_4_4_0_0_BACD(G, H, NormA, NormB, NormC, NormD)
end subroutine auto2e_frontend_Spher_4_4_0_0
end module auto2e_eri_ggss