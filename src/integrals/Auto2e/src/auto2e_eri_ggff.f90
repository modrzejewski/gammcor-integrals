...
! Angular momenta: A=4, B=4, C=3, and D=3
!
...
subroutine auto2e_eri_4_4_3_3(G, Ra, CntrA, ExpA, NprimA, &
Rb, CntrB, ExpB, NprimB, Rc, CntrC, ExpC, NprimC, &
Rd, CntrD, ExpD, NprimD, Kappa)
!
! Two-electron integrals class: (gg|ff)
...
real(F64), dimension(145, 74) :: W
!
! Compute (LS|KS) integrals, L=4..8 and K=3..6
!
W = ZERO
...
call auto2e_W_8_6(W, Ra, CntrA, ExpA, NprimA, Rb, CntrB, ExpB, NprimB, &
   Rc, CntrC, ExpC, NprimC, Rd, CntrD, ExpD, NprimD, Kappa, 101, 47)
call auto2e_BraKetTransfer_4_4_3_3(G, W, Ra, Rb, Rc, Rd)
end subroutine auto2e_eri_4_4_3_3

subroutine auto2e_eri_Spher_4_4_3_3(G, Ra, CntrA, ExpA, NprimA, &
Rb, CntrB, ExpB, NprimB, Rc, CntrC, ExpC, NprimC, &
Rd, CntrD, ExpD, NprimD, Kappa)
!
! Two-electron integrals class: (gg|ff)
...
call auto2e_W_8_6(W, Ra, CntrA, ExpA, NprimA, Rb, CntrB, ExpB, NprimB, &
   Rc, CntrC, ExpC, NprimC, Rd, CntrD, ExpD, NprimD, Kappa, 101, 47)
call auto2e_BraKetTransfer_Spher_4_4_3_3(G, W, Ra, Rb, Rc, Rd)
end subroutine auto2e_eri_Spher_4_4_3_3

subroutine auto2e_BraKetTransfer_4_4_3_3(G, W, Ra, Rb, Rc, Rd)
!
! Transform (LS|KS), L=4..8, K=3..6 using the horizontal recurrence relation
...
real(F64), dimension(145, 74), intent(in) :: W
real(F64), dimension(3), intent(in) :: Ra, Rb, Rc, Rd
real(F64), dimension(3) :: AB, CD
real(F64), dimension(145, 100) :: T
real(F64), dimension(100, 145) :: U
AB = Ra - Rb
CD = Rc - Rd
call auto2e_KetTransfer_3_3(T, W, CD(1), CD(2), CD(3))
U = transpose(T)
call auto2e_KetTransfer_4_4(G(:, 1:225), U, AB(1), AB(2), AB(3))
end subroutine auto2e_BraKetTransfer_4_4_3_3

subroutine auto2e_BraKetTransfer_Spher_4_4_3_3(G, W, Ra, Rb, Rc, Rd)
!
! Transform (LS|KS), L=4..8, K=3..6 using the horizontal recurrence relation
! of Eq. 18 in Head-Gordon, M. and Pople, J.A. J. Chem. Phys. 89, 5777 (1988);
! doi: 10.1063/1.455553
...
real(F64), dimension(3), intent(in) :: Ra, Rb, Rc, Rd
real(F64), dimension(3) :: AB, CD
real(F64), dimension(145, 100) :: Txyz
real(F64), dimension(145, 49) :: T
real(F64), dimension(49, 145) :: U
real(F64), dimension(49, 225) :: Gxyz
AB = Ra - Rb
CD = Rc - Rd
call auto2e_KetTransfer_3_3(Txyz, W, CD(1), CD(2), CD(3))
call auto2e_SpherTransf_U_Vector_3_3(T, Txyz, 145)
U = transpose(T)
call auto2e_KetTransfer_4_4(Gxyz, U, AB(1), AB(2), AB(3))
call auto2e_SpherTransf_U_Vector_4_4(G(:, 1:81), Gxyz, 49)
end subroutine auto2e_BraKetTransfer_Spher_4_4_3_3

subroutine auto2e_Normalize_4_4_3_3_BADC(Gbadc, Gcdab, NormA, NormB, NormC, NormD)
!
...
end subroutine auto2e_Normalize_4_4_3_3_BADC

subroutine auto2e_Normalize_4_4_3_3_DCBA(Gdcba, Gcdab, NormA, NormB, NormC, NormD)
!
! Apply L-dependent normalization constants and change the memory layout:
!
! Input memory layout: CDAB
...
end subroutine auto2e_Normalize_4_4_3_3_DCBA

subroutine auto2e_Normalize_Spher_4_4_3_3_BADC(Gbadc, Gcdab, NormA, NormB, NormC, NormD)
!
! Apply L-dependent normalization constants and change the memory layout:
!
! Input memory layout: CDAB
...
end subroutine auto2e_Normalize_Spher_4_4_3_3_BADC

subroutine auto2e_Normalize_Spher_4_4_3_3_DCBA(Gdcba, Gcdab, NormA, NormB, NormC, NormD)
!
! Apply L-dependent normalization constants and change the memory layout:
!
! Input memory layout: CDAB
...
end subroutine auto2e_Normalize_Spher_4_4_3_3_DCBA

subroutine auto2e_frontend_3_3_4_4(G, Ra, CntrA, NormA, ExpA, NprimA, &
...
call auto2e_eri_4_4_3_3(H, Rc, CntrC, ExpC, NprimC, &
   Rd, CntrD, ExpD, NprimD, &
   Ra, CntrA, ExpA, NprimA, &
   Rb, CntrB, ExpB, NprimB, Kappa)
call auto2e_Normalize_4_4_3_3_BADC(G, H, NormC, NormD, NormA, NormB)
end subroutine auto2e_frontend_3_3_4_4

subroutine auto2e_frontend_Spher_3_3_4_4(G, Ra, CntrA, NormA, ExpA, NprimA, &
Rb, CntrB, NormB, ExpB, NprimB, Rc, CntrC, NormC, ExpC, NprimC, &
Rd, CntrD, NormD, ExpD, NprimD, Kappa)
real(F64), dimension(*), intent(out) :: G
real(F64), dimension(3), intent(in) :: Ra, Rb, Rc, Rd
...
call auto2e_eri_Spher_4_4_3_3(H, Rc, CntrC, ExpC, NprimC, &
   Rd, CntrD, ExpD, NprimD, &
   Ra, CntrA, ExpA, NprimA, &
   Rb, CntrB, ExpB, NprimB, Kappa)
call auto2e_Normalize_Spher_4_4_3_3_BADC(G, H, NormC, NormD, NormA, NormB)
end subroutine auto2e_frontend_Spher_3_3_4_4

subroutine auto2e_frontend_4_4_3_3(G, Ra, CntrA, NormA, ExpA, NprimA, &
Rb, CntrB, NormB, ExpB, NprimB, Rc, CntrC, NormC, ExpC, NprimC, &
Rd, CntrD, NormD, ExpD, NprimD, Kappa)
real(F64), dimension(*), intent(out) :: G
real(F64), dimension(3), intent(in) :: Ra, Rb, Rc, Rd
...
real(F64), intent(in) :: Kappa
real(F64), dimension(22500) :: H
call auto2e_eri_4_4_3_3(H, Ra, CntrA, ExpA, NprimA, &
   Rb, CntrB, ExpB, NprimB, &
   Rc, CntrC, ExpC, NprimC, &
   Rd, CntrD, ExpD, NprimD, Kappa)
call auto2e_Normalize_4_4_3_3_DCBA(G, H, NormA, NormB, NormC, NormD)
end subroutine auto2e_frontend_4_4_3_3

subroutine auto2e_frontend_Spher_4_4_3_3(G, Ra, CntrA, NormA, ExpA, NprimA, &
Rb, CntrB, NormB, ExpB, NprimB, Rc, CntrC, NormC, ExpC, NprimC, &
Rd, CntrD, NormD, ExpD, NprimD, Kappa)
real(F64), dimension(*), intent(out) :: G
real(F64), dimension(3), intent(in) :: Ra, Rb, Rc, Rd
...
real(F64), intent(in) :: Kappa
real(F64), dimension(3969) :: H
call auto2e_eri_Spher_4_4_3_3(H, Ra, CntrA, ExpA, NprimA, &
   Rb, CntrB, ExpB, NprimB, &
   Rc, CntrC, ExpC, NprimC, &
   Rd, CntrD, ExpD, NprimD, Kappa)
call auto2e_Normalize_Spher_4_4_3_3_DCBA(G, H, NormA, NormB, NormC, NormD)
end subroutine auto2e_frontend_Spher_4_4_3_3
end module auto2e_eri_ggff