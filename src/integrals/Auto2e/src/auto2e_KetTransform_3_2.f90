...
S(1:4) = Ey(1)*Ez(1)*(Ex(4)*R(1:4) - Ex(5)*R(2:5) + Ex(6)*R(3:6))
S(5:7) = Ey(1)*Ez(1)*(Ex(4)*R(7:9) - Ex(5)*R(8:10) + Ex(6)*R(9:11))
S(8:9) = Ey(1)*Ez(1)*(Ex(4)*R(12:13) - Ex(5)*R(13:14) + Ex(6)*R(14:15))
S(10) = Ey(1)*Ez(1)*(Ex(4)*R(16) - Ex(5)*R(17) + Ex(6)*R(18))
S(11:13) = Ey(1)*Ez(1)*(Ex(4)*R(22:24) - Ex(5)*R(23:25) + Ex(6)*R(24:26))
S(14:15) = Ey(1)*Ez(1)*(Ex(4)*R(27:28) - Ex(5)*R(28:29) + Ex(6)*R(29:30))
S(16) = Ey(1)*Ez(1)*(Ex(4)*R(31) - Ex(5)*R(32) + Ex(6)*R(33))
S(17:18) = Ey(1)*Ez(1)*(Ex(4)*R(37:38) - Ex(5)*R(38:39) + Ex(6)*R(39:40))
S(19) = Ey(1)*Ez(1)*(Ex(4)*R(41) - Ex(5)*R(42) + Ex(6)*R(43))
S(20) = Ey(1)*Ez(1)*(Ex(4)*R(47) - Ex(5)*R(48) + Ex(6)*R(49))
...
real(F64), dimension(:), intent(in) :: Ez
real(F64), dimension(:), intent(in) :: R
S(1:4) = Ey(2)*Ez(1)*(Ex(2)*R(1:4) - Ex(3)*R(2:5)) + Ey(3)*Ez(1)*(-Ex(2)*R(7:10)  &
   + Ex(3)*R(8:11))
S(5:7) = Ey(2)*Ez(1)*(Ex(2)*R(7:9) - Ex(3)*R(8:10)) + Ey(3)*Ez(1)*(-Ex(2)*R(12:14)  &
   + Ex(3)*R(13:15))
S(8:9) = Ey(2)*Ez(1)*(Ex(2)*R(12:13) - Ex(3)*R(13:14)) + Ey(3)*Ez(1)*(-Ex(2)*R(16:17)  &
   + Ex(3)*R(17:18))
S(10) = Ey(2)*Ez(1)*(Ex(2)*R(16) - Ex(3)*R(17)) + Ey(3)*Ez(1)*(-Ex(2)*R(19) + Ex(3) &
   *R(20))
S(11:13) = Ey(2)*Ez(1)*(Ex(2)*R(22:24) - Ex(3)*R(23:25)) + Ey(3)*Ez(1)*(-Ex(2)*R(27:29)  &
   + Ex(3)*R(28:30))
S(14:15) = Ey(2)*Ez(1)*(Ex(2)*R(27:28) - Ex(3)*R(28:29)) + Ey(3)*Ez(1)*(-Ex(2)*R(31:32)  &
   + Ex(3)*R(32:33))
S(16) = Ey(2)*Ez(1)*(Ex(2)*R(31) - Ex(3)*R(32)) + Ey(3)*Ez(1)*(-Ex(2)*R(34) + Ex(3) &
   *R(35))
S(17:18) = Ey(2)*Ez(1)*(Ex(2)*R(37:38) - Ex(3)*R(38:39)) + Ey(3)*Ez(1)*(-Ex(2)*R(41:42)  &
   + Ex(3)*R(42:43))
S(19) = Ey(2)*Ez(1)*(Ex(2)*R(41) - Ex(3)*R(42)) + Ey(3)*Ez(1)*(-Ex(2)*R(44) + Ex(3) &
   *R(45))
S(20) = Ey(2)*Ez(1)*(Ex(2)*R(47) - Ex(3)*R(48)) + Ey(3)*Ez(1)*(-Ex(2)*R(50) + Ex(3) &
   *R(51))
...
real(F64), dimension(:), intent(in) :: Ez
real(F64), dimension(:), intent(in) :: R
S(1:4) = Ey(1)*Ex(1)*(Ez(4)*R(1:4) - Ez(5)*R(22:25) + Ez(6)*R(37:40))
S(5:7) = Ey(1)*Ex(1)*(Ez(4)*R(7:9) - Ez(5)*R(27:29) + Ez(6)*R(41:43))
S(8:9) = Ey(1)*Ex(1)*(Ez(4)*R(12:13) - Ez(5)*R(31:32) + Ez(6)*R(44:45))
S(10) = Ey(1)*Ex(1)*(Ez(4)*R(16) - Ez(5)*R(34) + Ez(6)*R(46))
S(11:13) = Ey(1)*Ex(1)*(Ez(4)*R(22:24) - Ez(5)*R(37:39) + Ez(6)*R(47:49))
S(14:15) = Ey(1)*Ex(1)*(Ez(4)*R(27:28) - Ez(5)*R(41:42) + Ez(6)*R(50:51))
S(16) = Ey(1)*Ex(1)*(Ez(4)*R(31) - Ez(5)*R(44) + Ez(6)*R(52))
S(17:18) = Ey(1)*Ex(1)*(Ez(4)*R(37:38) - Ez(5)*R(47:48) + Ez(6)*R(53:54))
S(19) = Ey(1)*Ex(1)*(Ez(4)*R(41) - Ez(5)*R(50) + Ez(6)*R(55))
S(20) = Ey(1)*Ex(1)*(Ez(4)*R(47) - Ez(5)*R(53) + Ez(6)*R(56))
