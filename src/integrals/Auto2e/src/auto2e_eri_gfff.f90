...
! Angular momenta: A=4, B=3, C=3, and D=3
!
...
subroutine auto2e_eri_4_3_3_3(G, Ra, CntrA, ExpA, NprimA, &
Rb, CntrB, ExpB, NprimB, Rc, CntrC, ExpC, NprimC, &
Rd, CntrD, ExpD, NprimD, Kappa)
!
! Two-electron integrals class: (gf|ff)
...
real(F64), dimension(100, 74) :: W
!
! Compute (LS|KS) integrals, L=4..7 and K=3..6
!
W = ZERO
...
call auto2e_W_7_6(W, Ra, CntrA, ExpA, NprimA, Rb, CntrB, ExpB, NprimB, &
   Rc, CntrC, ExpC, NprimC, Rd, CntrD, ExpD, NprimD, Kappa, 65, 47)
call auto2e_BraKetTransfer_4_3_3_3(G, W, Ra, Rb, Rc, Rd)
end subroutine auto2e_eri_4_3_3_3

subroutine auto2e_eri_Spher_4_3_3_3(G, Ra, CntrA, ExpA, NprimA, &
Rb, CntrB, ExpB, NprimB, Rc, CntrC, ExpC, NprimC, &
Rd, CntrD, ExpD, NprimD, Kappa)
!
! Two-electron integrals class: (gf|ff)
...
call auto2e_W_7_6(W, Ra, CntrA, ExpA, NprimA, Rb, CntrB, ExpB, NprimB, &
   Rc, CntrC, ExpC, NprimC, Rd, CntrD, ExpD, NprimD, Kappa, 65, 47)
call auto2e_BraKetTransfer_Spher_4_3_3_3(G, W, Ra, Rb, Rc, Rd)
end subroutine auto2e_eri_Spher_4_3_3_3

subroutine auto2e_BraKetTransfer_4_3_3_3(G, W, Ra, Rb, Rc, Rd)
!
! Transform (LS|KS), L=4..7, K=3..6 using the horizontal recurrence relation
...
real(F64), dimension(100, 74), intent(in) :: W
real(F64), dimension(3), intent(in) :: Ra, Rb, Rc, Rd
real(F64), dimension(3) :: AB, CD
real(F64), dimension(100, 100) :: T
real(F64), dimension(100, 100) :: U
AB = Ra - Rb
CD = Rc - Rd
call auto2e_KetTransfer_3_3(T, W, CD(1), CD(2), CD(3))
U = transpose(T)
call auto2e_KetTransfer_4_3(G(:, 1:150), U, AB(1), AB(2), AB(3))
end subroutine auto2e_BraKetTransfer_4_3_3_3

subroutine auto2e_BraKetTransfer_Spher_4_3_3_3(G, W, Ra, Rb, Rc, Rd)
!
! Transform (LS|KS), L=4..7, K=3..6 using the horizontal recurrence relation
! of Eq. 18 in Head-Gordon, M. and Pople, J.A. J. Chem. Phys. 89, 5777 (1988);
! doi: 10.1063/1.455553
...
real(F64), dimension(3), intent(in) :: Ra, Rb, Rc, Rd
real(F64), dimension(3) :: AB, CD
real(F64), dimension(100, 100) :: Txyz
real(F64), dimension(100, 49) :: T
real(F64), dimension(49, 100) :: U
real(F64), dimension(49, 150) :: Gxyz
AB = Ra - Rb
CD = Rc - Rd
call auto2e_KetTransfer_3_3(Txyz, W, CD(1), CD(2), CD(3))
call auto2e_SpherTransf_U_Vector_3_3(T, Txyz, 100)
U = transpose(T)
call auto2e_KetTransfer_4_3(Gxyz, U, AB(1), AB(2), AB(3))
call auto2e_SpherTransf_U_Vector_4_3(G(:, 1:63), Gxyz, 49)
end subroutine auto2e_BraKetTransfer_Spher_4_3_3_3

subroutine auto2e_Normalize_4_3_3_3_ABDC(Gabdc, Gcdab, NormA, NormB, NormC, NormD)
!
...
end subroutine auto2e_Normalize_4_3_3_3_ABDC

subroutine auto2e_Normalize_4_3_3_3_BADC(Gbadc, Gcdab, NormA, NormB, NormC, NormD)
!
! Apply L-dependent normalization constants and change the memory layout:
!
! Input memory layout: CDAB
...
end subroutine auto2e_Normalize_4_3_3_3_BADC

subroutine auto2e_Normalize_4_3_3_3_DCAB(Gdcab, Gcdab, NormA, NormB, NormC, NormD)
!
! Apply L-dependent normalization constants and change the memory layout:
!
! Input memory layout: CDAB
...
end subroutine auto2e_Normalize_4_3_3_3_DCAB

subroutine auto2e_Normalize_4_3_3_3_DCBA(Gdcba, Gcdab, NormA, NormB, NormC, NormD)
!
! Apply L-dependent normalization constants and change the memory layout:
!
! Input memory layout: CDAB
...
end subroutine auto2e_Normalize_4_3_3_3_DCBA

subroutine auto2e_Normalize_Spher_4_3_3_3_ABDC(Gabdc, Gcdab, NormA, NormB, NormC, NormD)
!
! Apply L-dependent normalization constants and change the memory layout:
!
! Input memory layout: CDAB
...
end subroutine auto2e_Normalize_Spher_4_3_3_3_ABDC

subroutine auto2e_Normalize_Spher_4_3_3_3_BADC(Gbadc, Gcdab, NormA, NormB, NormC, NormD)
!
! Apply L-dependent normalization constants and change the memory layout:
!
! Input memory layout: CDAB
...
end subroutine auto2e_Normalize_Spher_4_3_3_3_BADC

subroutine auto2e_Normalize_Spher_4_3_3_3_DCAB(Gdcab, Gcdab, NormA, NormB, NormC, NormD)
!
! Apply L-dependent normalization constants and change the memory layout:
!
! Input memory layout: CDAB
...
end subroutine auto2e_Normalize_Spher_4_3_3_3_DCAB

subroutine auto2e_Normalize_Spher_4_3_3_3_DCBA(Gdcba, Gcdab, NormA, NormB, NormC, NormD)
!
! Apply L-dependent normalization constants and change the memory layout:
!
! Input memory layout: CDAB
...
end subroutine auto2e_Normalize_Spher_4_3_3_3_DCBA

subroutine auto2e_frontend_3_3_3_4(G, Ra, CntrA, NormA, ExpA, NprimA, &
...
integer, intent(in) :: NprimA, NprimB, NprimC, NprimD
real(F64), intent(in) :: Kappa
real(F64), dimension(15000) :: H
call auto2e_eri_4_3_3_3(H, Rd, CntrD, ExpD, NprimD, &
   Rc, CntrC, ExpC, NprimC, &
   Ra, CntrA, ExpA, NprimA, &
   Rb, CntrB, ExpB, NprimB, Kappa)
call auto2e_Normalize_4_3_3_3_ABDC(G, H, NormD, NormC, NormA, NormB)
end subroutine auto2e_frontend_3_3_3_4

subroutine auto2e_frontend_Spher_3_3_3_4(G, Ra, CntrA, NormA, ExpA, NprimA, &
Rb, CntrB, NormB, ExpB, NprimB, Rc, CntrC, NormC, ExpC, NprimC, &
Rd, CntrD, NormD, ExpD, NprimD, Kappa)
real(F64), dimension(*), intent(out) :: G
real(F64), dimension(3), intent(in) :: Ra, Rb, Rc, Rd
...
integer, intent(in) :: NprimA, NprimB, NprimC, NprimD
real(F64), intent(in) :: Kappa
real(F64), dimension(3087) :: H
call auto2e_eri_Spher_4_3_3_3(H, Rd, CntrD, ExpD, NprimD, &
   Rc, CntrC, ExpC, NprimC, &
   Ra, CntrA, ExpA, NprimA, &
   Rb, CntrB, ExpB, NprimB, Kappa)
call auto2e_Normalize_Spher_4_3_3_3_ABDC(G, H, NormD, NormC, NormA, NormB)
end subroutine auto2e_frontend_Spher_3_3_3_4

subroutine auto2e_frontend_4_3_3_3(G, Ra, CntrA, NormA, ExpA, NprimA, &
Rb, CntrB, NormB, ExpB, NprimB, Rc, CntrC, NormC, ExpC, NprimC, &
Rd, CntrD, NormD, ExpD, NprimD, Kappa)
real(F64), dimension(*), intent(out) :: G
real(F64), dimension(3), intent(in) :: Ra, Rb, Rc, Rd
...
real(F64), intent(in) :: Kappa
real(F64), dimension(15000) :: H
call auto2e_eri_4_3_3_3(H, Ra, CntrA, ExpA, NprimA, &
   Rb, CntrB, ExpB, NprimB, &
   Rc, CntrC, ExpC, NprimC, &
   Rd, CntrD, ExpD, NprimD, Kappa)
call auto2e_Normalize_4_3_3_3_DCBA(G, H, NormA, NormB, NormC, NormD)
end subroutine auto2e_frontend_4_3_3_3

subroutine auto2e_frontend_Spher_4_3_3_3(G, Ra, CntrA, NormA, ExpA, NprimA, &
Rb, CntrB, NormB, ExpB, NprimB, Rc, CntrC, NormC, ExpC, NprimC, &
Rd, CntrD, NormD, ExpD, NprimD, Kappa)
real(F64), dimension(*), intent(out) :: G
real(F64), dimension(3), intent(in) :: Ra, Rb, Rc, Rd
...
real(F64), intent(in) :: Kappa
real(F64), dimension(3087) :: H
call auto2e_eri_Spher_4_3_3_3(H, Ra, CntrA, ExpA, NprimA, &
   Rb, CntrB, ExpB, NprimB, &
   Rc, CntrC, ExpC, NprimC, &
   Rd, CntrD, ExpD, NprimD, Kappa)
call auto2e_Normalize_Spher_4_3_3_3_DCBA(G, H, NormA, NormB, NormC, NormD)
end subroutine auto2e_frontend_Spher_4_3_3_3

subroutine auto2e_frontend_3_4_3_3(G, Ra, CntrA, NormA, ExpA, NprimA, &
Rb, CntrB, NormB, ExpB, NprimB, Rc, CntrC, NormC, ExpC, NprimC, &
Rd, CntrD, NormD, ExpD, NprimD, Kappa)
real(F64), dimension(*), intent(out) :: G
real(F64), dimension(3), intent(in) :: Ra, Rb, Rc, Rd
...
real(F64), intent(in) :: Kappa
real(F64), dimension(15000) :: H
call auto2e_eri_4_3_3_3(H, Rb, CntrB, ExpB, NprimB, &
   Ra, CntrA, ExpA, NprimA, &
   Rc, CntrC, ExpC, NprimC, &
   Rd, CntrD, ExpD, NprimD, Kappa)
call auto2e_Normalize_4_3_3_3_DCAB(G, H, NormB, NormA, NormC, NormD)
end subroutine auto2e_frontend_3_4_3_3

subroutine auto2e_frontend_Spher_3_4_3_3(G, Ra, CntrA, NormA, ExpA, NprimA, &
Rb, CntrB, NormB, ExpB, NprimB, Rc, CntrC, NormC, ExpC, NprimC, &
Rd, CntrD, NormD, ExpD, NprimD, Kappa)
real(F64), dimension(*), intent(out) :: G
real(F64), dimension(3), intent(in) :: Ra, Rb, Rc, Rd
...
real(F64), intent(in) :: Kappa
real(F64), dimension(3087) :: H
call auto2e_eri_Spher_4_3_3_3(H, Rb, CntrB, ExpB, NprimB, &
   Ra, CntrA, ExpA, NprimA, &
   Rc, CntrC, ExpC, NprimC, &
   Rd, CntrD, ExpD, NprimD, Kappa)
call auto2e_Normalize_Spher_4_3_3_3_DCAB(G, H, NormB, NormA, NormC, NormD)
end subroutine auto2e_frontend_Spher_3_4_3_3

subroutine auto2e_frontend_3_3_4_3(G, Ra, CntrA, NormA, ExpA, NprimA, &
Rb, CntrB, NormB, ExpB, NprimB, Rc, CntrC, NormC, ExpC, NprimC, &
Rd, CntrD, NormD, ExpD, NprimD, Kappa)
real(F64), dimension(*), intent(out) :: G
real(F64), dimension(3), intent(in) :: Ra, Rb, Rc, Rd
...
real(F64), intent(in) :: Kappa
real(F64), dimension(15000) :: H
call auto2e_eri_4_3_3_3(H, Rc, CntrC, ExpC, NprimC, &
   Rd, CntrD, ExpD, NprimD, &
   Ra, CntrA, ExpA, NprimA, &
   Rb, CntrB, ExpB, NprimB, Kappa)
call auto2e_Normalize_4_3_3_3_BADC(G, H, NormC, NormD, NormA, NormB)
end subroutine auto2e_frontend_3_3_4_3

subroutine auto2e_frontend_Spher_3_3_4_3(G, Ra, CntrA, NormA, ExpA, NprimA, &
Rb, CntrB, NormB, ExpB, NprimB, Rc, CntrC, NormC, ExpC, NprimC, &
Rd, CntrD, NormD, ExpD, NprimD, Kappa)
real(F64), dimension(*), intent(out) :: G
real(F64), dimension(3), intent(in) :: Ra, Rb, Rc, Rd
...
real(F64), intent(in) :: Kappa
real(F64), dimension(3087) :: H
call auto2e_eri_Spher_4_3_3_3(H, Rc, CntrC, ExpC, NprimC, &
   Rd, CntrD, ExpD, NprimD, &
   Ra, CntrA, ExpA, NprimA, &
   Rb, CntrB, ExpB, NprimB, Kappa)
call auto2e_Normalize_Spher_4_3_3_3_BADC(G, H, NormC, NormD, NormA, NormB)
end subroutine auto2e_frontend_Spher_3_3_4_3
end module auto2e_eri_gfff