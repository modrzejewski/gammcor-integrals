...
! Angular momenta: A=4, B=4, C=4, and D=4
!
...
subroutine auto2e_eri_4_4_4_4(G, Ra, CntrA, ExpA, NprimA, &
Rb, CntrB, ExpB, NprimB, Rc, CntrC, ExpC, NprimC, &
Rd, CntrD, ExpD, NprimD, Kappa)
!
! Two-electron integrals class: (gg|gg)
...
real(F64), dimension(145, 145) :: W
!
! Compute (LS|KS) integrals, L=4..8 and K=4..8
!
W = ZERO
...
call auto2e_W_4_8(W, Ra, CntrA, ExpA, NprimA, Rb, CntrB, ExpB, NprimB, &
   Rc, CntrC, ExpC, NprimC, Rd, CntrD, ExpD, NprimD, Kappa, 1, 101)
call auto2e_W_5_8(W, Ra, CntrA, ExpA, NprimA, Rb, CntrB, ExpB, NprimB, &
   Rc, CntrC, ExpC, NprimC, Rd, CntrD, ExpD, NprimD, Kappa, 16, 101)
call auto2e_W_6_8(W, Ra, CntrA, ExpA, NprimA, Rb, CntrB, ExpB, NprimB, &
   Rc, CntrC, ExpC, NprimC, Rd, CntrD, ExpD, NprimD, Kappa, 37, 101)
call auto2e_W_7_8(W, Ra, CntrA, ExpA, NprimA, Rb, CntrB, ExpB, NprimB, &
   Rc, CntrC, ExpC, NprimC, Rd, CntrD, ExpD, NprimD, Kappa, 65, 101)
call auto2e_W_8_8(W, Ra, CntrA, ExpA, NprimA, Rb, CntrB, ExpB, NprimB, &
   Rc, CntrC, ExpC, NprimC, Rd, CntrD, ExpD, NprimD, Kappa, 101, 101)
call auto2e_BraKetTransfer_4_4_4_4(G, W, Ra, Rb, Rc, Rd)
end subroutine auto2e_eri_4_4_4_4

subroutine auto2e_eri_Spher_4_4_4_4(G, Ra, CntrA, ExpA, NprimA, &
Rb, CntrB, ExpB, NprimB, Rc, CntrC, ExpC, NprimC, &
Rd, CntrD, ExpD, NprimD, Kappa)
!
! Two-electron integrals class: (gg|gg)
...
call auto2e_W_8_8(W, Ra, CntrA, ExpA, NprimA, Rb, CntrB, ExpB, NprimB, &
   Rc, CntrC, ExpC, NprimC, Rd, CntrD, ExpD, NprimD, Kappa, 101, 101)
call auto2e_BraKetTransfer_Spher_4_4_4_4(G, W, Ra, Rb, Rc, Rd)
end subroutine auto2e_eri_Spher_4_4_4_4

subroutine auto2e_BraKetTransfer_4_4_4_4(G, W, Ra, Rb, Rc, Rd)
!
! Transform (LS|KS), L=4..8, K=4..8 using the horizontal recurrence relation
...
!
real(F64), dimension(225, *), intent(out) :: G
real(F64), dimension(145, 145), intent(in) :: W
real(F64), dimension(3), intent(in) :: Ra, Rb, Rc, Rd
real(F64), dimension(3) :: AB, CD
real(F64), dimension(145, 225) :: T
real(F64), dimension(225, 145) :: U
AB = Ra - Rb
CD = Rc - Rd
call auto2e_KetTransfer_4_4(T, W, CD(1), CD(2), CD(3))
U = transpose(T)
call auto2e_KetTransfer_4_4(G(:, 1:225), U, AB(1), AB(2), AB(3))
end subroutine auto2e_BraKetTransfer_4_4_4_4

subroutine auto2e_BraKetTransfer_Spher_4_4_4_4(G, W, Ra, Rb, Rc, Rd)
!
! Transform (LS|KS), L=4..8, K=4..8 using the horizontal recurrence relation
! of Eq. 18 in Head-Gordon, M. and Pople, J.A. J. Chem. Phys. 89, 5777 (1988);
! doi: 10.1063/1.455553
...
real(F64), dimension(3), intent(in) :: Ra, Rb, Rc, Rd
real(F64), dimension(3) :: AB, CD
real(F64), dimension(145, 225) :: Txyz
real(F64), dimension(145, 81) :: T
real(F64), dimension(81, 145) :: U
real(F64), dimension(81, 225) :: Gxyz
AB = Ra - Rb
CD = Rc - Rd
call auto2e_KetTransfer_4_4(Txyz, W, CD(1), CD(2), CD(3))
call auto2e_SpherTransf_U_Vector_4_4(T, Txyz, 145)
U = transpose(T)
call auto2e_KetTransfer_4_4(Gxyz, U, AB(1), AB(2), AB(3))
call auto2e_SpherTransf_U_Vector_4_4(G(:, 1:81), Gxyz, 81)
end subroutine auto2e_BraKetTransfer_Spher_4_4_4_4

subroutine auto2e_Normalize_4_4_4_4_DCBA(Gdcba, Gcdab, NormA, NormB, NormC, NormD)
!
...
end subroutine auto2e_Normalize_4_4_4_4_DCBA

subroutine auto2e_Normalize_Spher_4_4_4_4_DCBA(Gdcba, Gcdab, NormA, NormB, NormC, NormD)
!
! Apply L-dependent normalization constants and change the memory layout:
!
! Input memory layout: CDAB
...
end subroutine auto2e_Normalize_Spher_4_4_4_4_DCBA

subroutine auto2e_frontend_4_4_4_4(G, Ra, CntrA, NormA, ExpA, NprimA, &
...
integer, intent(in) :: NprimA, NprimB, NprimC, NprimD
real(F64), intent(in) :: Kappa
real(F64), dimension(50625) :: H
call auto2e_eri_4_4_4_4(H, Ra, CntrA, ExpA, NprimA, &
   Rb, CntrB, ExpB, NprimB, &
   Rc, CntrC, ExpC, NprimC, &
   Rd, CntrD, ExpD, NprimD, Kappa)
call auto2e_Normalize_4_4_4_4_DCBA(G, H, NormA, NormB, NormC, NormD)
end subroutine auto2e_frontend_4_4_4_4

subroutine auto2e_frontend_Spher_4_4_4_4(G, Ra, CntrA, NormA, ExpA, NprimA, &
Rb, CntrB, NormB, ExpB, NprimB, Rc, CntrC, NormC, ExpC, NprimC, &
Rd, CntrD, NormD, ExpD, NprimD, Kappa)
real(F64), dimension(*), intent(out) :: G
real(F64), dimension(3), intent(in) :: Ra, Rb, Rc, Rd
...
integer, intent(in) :: NprimA, NprimB, NprimC, NprimD
real(F64), intent(in) :: Kappa
real(F64), dimension(6561) :: H
call auto2e_eri_Spher_4_4_4_4(H, Ra, CntrA, ExpA, NprimA, &
   Rb, CntrB, ExpB, NprimB, &
   Rc, CntrC, ExpC, NprimC, &
   Rd, CntrD, ExpD, NprimD, Kappa)
call auto2e_Normalize_Spher_4_4_4_4_DCBA(G, H, NormA, NormB, NormC, NormD)
end subroutine auto2e_frontend_Spher_4_4_4_4
end module auto2e_eri_gggg