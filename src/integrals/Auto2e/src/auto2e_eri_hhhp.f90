...
! Angular momenta: A=5, B=5, C=5, and D=1
!
...
subroutine auto2e_eri_5_5_5_1(G, Ra, CntrA, ExpA, NprimA, &
Rb, CntrB, ExpB, NprimB, Rc, CntrC, ExpC, NprimC, &
Rd, CntrD, ExpD, NprimD, Kappa)
!
! Two-electron integrals class: (hh|hp)
...
real(F64), dimension(251, 49) :: W
!
! Compute (LS|KS) integrals, L=5..10 and K=5..6
!
W = ZERO
...
call auto2e_BraKetTransfer_5_5_5_1(G, W, Ra, Rb, Rc, Rd)
end subroutine auto2e_eri_5_5_5_1

subroutine auto2e_eri_Spher_5_5_5_1(G, Ra, CntrA, ExpA, NprimA, &
Rb, CntrB, ExpB, NprimB, Rc, CntrC, ExpC, NprimC, &
Rd, CntrD, ExpD, NprimD, Kappa)
!
! Two-electron integrals class: (hh|hp)
...
call auto2e_W_10_6(W, Ra, CntrA, ExpA, NprimA, Rb, CntrB, ExpB, NprimB, &
   Rc, CntrC, ExpC, NprimC, Rd, CntrD, ExpD, NprimD, Kappa, 186, 22)
call auto2e_BraKetTransfer_Spher_5_5_5_1(G, W, Ra, Rb, Rc, Rd)
end subroutine auto2e_eri_Spher_5_5_5_1

subroutine auto2e_BraKetTransfer_5_5_5_1(G, W, Ra, Rb, Rc, Rd)
!
! Transform (LS|KS), L=5..10, K=5..6 using the horizontal recurrence relation
...
real(F64), dimension(251, 49), intent(in) :: W
real(F64), dimension(3), intent(in) :: Ra, Rb, Rc, Rd
...
end subroutine auto2e_BraKetTransfer_5_5_5_1

subroutine auto2e_BraKetTransfer_Spher_5_5_5_1(G, W, Ra, Rb, Rc, Rd)
!
! Transform (LS|KS), L=5..10, K=5..6 using the horizontal recurrence relation
! of Eq. 18 in Head-Gordon, M. and Pople, J.A. J. Chem. Phys. 89, 5777 (1988);
! doi: 10.1063/1.455553
...
real(F64), dimension(3), intent(in) :: Ra, Rb, Rc, Rd
real(F64), dimension(3) :: AB, CD
real(F64), dimension(251, 63) :: Txyz
real(F64), dimension(251, 33) :: T
real(F64), dimension(33, 251) :: U
real(F64), dimension(33, 441) :: Gxyz
AB = Ra - Rb
CD = Rc - Rd
call auto2e_KetTransfer_5_1(Txyz, W, CD(1), CD(2), CD(3))
call auto2e_SpherTransf_U_Vector_5_1(T, Txyz, 251)
U = transpose(T)
call auto2e_KetTransfer_5_5(Gxyz, U, AB(1), AB(2), AB(3))
call auto2e_SpherTransf_U_Vector_5_5(G(:, 1:121), Gxyz, 33)
end subroutine auto2e_BraKetTransfer_Spher_5_5_5_1

subroutine auto2e_Normalize_5_5_5_1_BACD(Gbacd, Gcdab, NormA, NormB, NormC, NormD)
!
...
end subroutine auto2e_Normalize_5_5_5_1_BACD

subroutine auto2e_Normalize_5_5_5_1_BADC(Gbadc, Gcdab, NormA, NormB, NormC, NormD)
!
! Apply L-dependent normalization constants and change the memory layout:
!
! Input memory layout: CDAB
...
end subroutine auto2e_Normalize_5_5_5_1_BADC

subroutine auto2e_Normalize_5_5_5_1_CDBA(Gcdba, Gcdab, NormA, NormB, NormC, NormD)
!
! Apply L-dependent normalization constants and change the memory layout:
!
! Input memory layout: CDAB
...
end subroutine auto2e_Normalize_5_5_5_1_CDBA

subroutine auto2e_Normalize_5_5_5_1_DCBA(Gdcba, Gcdab, NormA, NormB, NormC, NormD)
!
! Apply L-dependent normalization constants and change the memory layout:
!
! Input memory layout: CDAB
...
end subroutine auto2e_Normalize_5_5_5_1_DCBA

subroutine auto2e_Normalize_Spher_5_5_5_1_BACD(Gbacd, Gcdab, NormA, NormB, NormC, NormD)
!
! Apply L-dependent normalization constants and change the memory layout:
!
! Input memory layout: CDAB
...
end subroutine auto2e_Normalize_Spher_5_5_5_1_BACD

subroutine auto2e_Normalize_Spher_5_5_5_1_BADC(Gbadc, Gcdab, NormA, NormB, NormC, NormD)
!
! Apply L-dependent normalization constants and change the memory layout:
!
! Input memory layout: CDAB
...
end subroutine auto2e_Normalize_Spher_5_5_5_1_BADC

subroutine auto2e_Normalize_Spher_5_5_5_1_CDBA(Gcdba, Gcdab, NormA, NormB, NormC, NormD)
!
! Apply L-dependent normalization constants and change the memory layout:
!
! Input memory layout: CDAB
...
end subroutine auto2e_Normalize_Spher_5_5_5_1_CDBA

subroutine auto2e_Normalize_Spher_5_5_5_1_DCBA(Gdcba, Gcdab, NormA, NormB, NormC, NormD)
!
! Apply L-dependent normalization constants and change the memory layout:
!
! Input memory layout: CDAB
...
call auto2e_Normalize_5_5_5_1_CDBA(G, H, NormA, NormB, NormD, NormC)
end subroutine auto2e_frontend_5_5_1_5

subroutine auto2e_frontend_Spher_5_5_1_5(G, Ra, CntrA, NormA, ExpA, NprimA, &
Rb, CntrB, NormB, ExpB, NprimB, Rc, CntrC, NormC, ExpC, NprimC, &
Rd, CntrD, NormD, ExpD, NprimD, Kappa)
real(F64), dimension(*), intent(out) :: G
real(F64), dimension(3), intent(in) :: Ra, Rb, Rc, Rd
...
call auto2e_Normalize_5_5_5_1_BADC(G, H, NormC, NormD, NormA, NormB)
end subroutine auto2e_frontend_5_1_5_5

subroutine auto2e_frontend_Spher_5_1_5_5(G, Ra, CntrA, NormA, ExpA, NprimA, &
Rb, CntrB, NormB, ExpB, NprimB, Rc, CntrC, NormC, ExpC, NprimC, &
Rd, CntrD, NormD, ExpD, NprimD, Kappa)
real(F64), dimension(*), intent(out) :: G
real(F64), dimension(3), intent(in) :: Ra, Rb, Rc, Rd
...
call auto2e_eri_Spher_5_5_5_1(H, Rc, CntrC, ExpC, NprimC, &
   ...
   Ra, CntrA, ExpA, NprimA, &
   Rb, CntrB, ExpB, NprimB, Kappa)
call auto2e_Normalize_Spher_5_5_5_1_BADC(G, H, NormC, NormD, NormA, NormB)
end subroutine auto2e_frontend_Spher_5_1_5_5
end module auto2e_eri_hhhp