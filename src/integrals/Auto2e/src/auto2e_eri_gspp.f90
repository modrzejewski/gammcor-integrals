...
! Angular momenta: A=4, B=0, C=1, and D=1
!
...
subroutine auto2e_eri_4_0_1_1(G, Ra, CntrA, ExpA, NprimA, &
Rb, CntrB, ExpB, NprimB, Rc, CntrC, ExpC, NprimC, &
Rd, CntrD, ExpD, NprimD, Kappa)
!
! Two-electron integrals class: (gs|pp)
...
real(F64), dimension(15, 9) :: W
!
! Compute (LS|KS) integrals, L=4..4 and K=1..2
!
W = ZERO
...
call auto2e_BraKetTransfer_4_0_1_1(G, W, Rc, Rd)
end subroutine auto2e_eri_4_0_1_1

subroutine auto2e_eri_Spher_4_0_1_1(G, Ra, CntrA, ExpA, NprimA, &
Rb, CntrB, ExpB, NprimB, Rc, CntrC, ExpC, NprimC, &
Rd, CntrD, ExpD, NprimD, Kappa)
!
! Two-electron integrals class: (gs|pp)
...
call auto2e_W_4_2(W, Ra, CntrA, ExpA, NprimA, Rb, CntrB, ExpB, NprimB, &
   Rc, CntrC, ExpC, NprimC, Rd, CntrD, ExpD, NprimD, Kappa, 1, 4)
call auto2e_BraKetTransfer_Spher_4_0_1_1(G, W, Rc, Rd)
end subroutine auto2e_eri_Spher_4_0_1_1

subroutine auto2e_BraKetTransfer_4_0_1_1(G, W, Rc, Rd)
!
! Transform (LS|KS), L=4..4, K=1..2 using the horizontal recurrence relation
...
!
real(F64), dimension(15, *), intent(out) :: G
real(F64), dimension(15, 9), intent(in) :: W
real(F64), dimension(3), intent(in) :: Rc, Rd
real(F64), dimension(3) :: CD
CD = Rc - Rd
call auto2e_KetTransfer_1_1(G(:, 1:9), W, CD(1), CD(2), CD(3))
end subroutine auto2e_BraKetTransfer_4_0_1_1

subroutine auto2e_BraKetTransfer_Spher_4_0_1_1(G, W, Rc, Rd)
!
! Transform (LS|KS), L=4..4, K=1..2 using the horizontal recurrence relation
! of Eq. 18 in Head-Gordon, M. and Pople, J.A. J. Chem. Phys. 89, 5777 (1988);
! doi: 10.1063/1.455553
...
end subroutine auto2e_BraKetTransfer_Spher_4_0_1_1

subroutine auto2e_Normalize_4_0_1_1_ABDC(Gabdc, Gabcd, NormA, NormB, NormC, NormD)
!
...
end subroutine auto2e_Normalize_4_0_1_1_ABDC

subroutine auto2e_Normalize_4_0_1_1_DCAB(Gdcab, Gabcd, NormA, NormB, NormC, NormD)
!
! Apply L-dependent normalization constants and change the memory layout:
!
! Input memory layout: ABCD
...
end subroutine auto2e_Normalize_4_0_1_1_DCAB

subroutine auto2e_Normalize_Spher_4_0_1_1_ABDC(Gabdc, Gcdab, NormA, NormB, NormC, NormD)
!
! Apply L-dependent normalization constants and change the memory layout:
!
...
end subroutine auto2e_Normalize_Spher_4_0_1_1_ABDC

subroutine auto2e_Normalize_Spher_4_0_1_1_DCAB(Gdcab, Gcdab, NormA, NormB, NormC, NormD)
!
! Apply L-dependent normalization constants and change the memory layout:
!
! Input memory layout: CDAB
...
end subroutine auto2e_Normalize_Spher_4_0_1_1_DCAB

subroutine auto2e_frontend_0_4_1_1(G, Ra, CntrA, NormA, ExpA, NprimA, &
...
call auto2e_eri_4_0_1_1(H, Rb, CntrB, ExpB, NprimB, &
   Ra, CntrA, ExpA, NprimA, &
   Rc, CntrC, ExpC, NprimC, &
   Rd, CntrD, ExpD, NprimD, Kappa)
call auto2e_Normalize_4_0_1_1_DCAB(G, H, NormB, NormA, NormC, NormD)
end subroutine auto2e_frontend_0_4_1_1

subroutine auto2e_frontend_Spher_0_4_1_1(G, Ra, CntrA, NormA, ExpA, NprimA, &
Rb, CntrB, NormB, ExpB, NprimB, Rc, CntrC, NormC, ExpC, NprimC, &
Rd, CntrD, NormD, ExpD, NprimD, Kappa)
real(F64), dimension(*), intent(out) :: G
real(F64), dimension(3), intent(in) :: Ra, Rb, Rc, Rd
...
call auto2e_eri_Spher_4_0_1_1(H, Rb, CntrB, ExpB, NprimB, &
   Ra, CntrA, ExpA, NprimA, &
   Rc, CntrC, ExpC, NprimC, &
   Rd, CntrD, ExpD, NprimD, Kappa)
...
real(F64), intent(in) :: Kappa
real(F64), dimension(135) :: H
call auto2e_eri_4_0_1_1(H, Rd, CntrD, ExpD, NprimD, &
   Rc, CntrC, ExpC, NprimC, &
   Ra, CntrA, ExpA, NprimA, &
   Rb, CntrB, ExpB, NprimB, Kappa)
call auto2e_Normalize_4_0_1_1_ABDC(G, H, NormD, NormC, NormA, NormB)
end subroutine auto2e_frontend_1_1_0_4

subroutine auto2e_frontend_Spher_1_1_0_4(G, Ra, CntrA, NormA, ExpA, NprimA, &
Rb, CntrB, NormB, ExpB, NprimB, Rc, CntrC, NormC, ExpC, NprimC, &
Rd, CntrD, NormD, ExpD, NprimD, Kappa)
real(F64), dimension(*), intent(out) :: G
real(F64), dimension(3), intent(in) :: Ra, Rb, Rc, Rd
...
real(F64), intent(in) :: Kappa
real(F64), dimension(81) :: H
call auto2e_eri_Spher_4_0_1_1(H, Rd, CntrD, ExpD, NprimD, &
   Rc, CntrC, ExpC, NprimC, &
   Ra, CntrA, ExpA, NprimA, &
   Rb, CntrB, ExpB, NprimB, Kappa)
