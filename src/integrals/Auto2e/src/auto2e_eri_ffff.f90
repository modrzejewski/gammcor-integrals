...
! Angular momenta: A=3, B=3, C=3, and D=3
!
...
subroutine auto2e_eri_3_3_3_3(G, Ra, CntrA, ExpA, NprimA, &
Rb, CntrB, ExpB, NprimB, Rc, CntrC, ExpC, NprimC, &
Rd, CntrD, ExpD, NprimD, Kappa)
!
! Two-electron integrals class: (ff|ff)
...
real(F64), dimension(74, 74) :: W
!
! Compute (LS|KS) integrals, L=3..6 and K=3..6
!
W = ZERO
...
call auto2e_W_3_6(W, Ra, CntrA, ExpA, NprimA, Rb, CntrB, ExpB, NprimB, &
   Rc, CntrC, ExpC, NprimC, Rd, CntrD, ExpD, NprimD, Kappa, 1, 47)
call auto2e_W_4_6(W, Ra, CntrA, ExpA, NprimA, Rb, CntrB, ExpB, NprimB, &
   Rc, CntrC, ExpC, NprimC, Rd, CntrD, ExpD, NprimD, Kappa, 11, 47)
call auto2e_W_5_6(W, Ra, CntrA, ExpA, NprimA, Rb, CntrB, ExpB, NprimB, &
   Rc, CntrC, ExpC, NprimC, Rd, CntrD, ExpD, NprimD, Kappa, 26, 47)
call auto2e_W_6_6(W, Ra, CntrA, ExpA, NprimA, Rb, CntrB, ExpB, NprimB, &
   Rc, CntrC, ExpC, NprimC, Rd, CntrD, ExpD, NprimD, Kappa, 47, 47)
call auto2e_BraKetTransfer_3_3_3_3(G, W, Ra, Rb, Rc, Rd)
end subroutine auto2e_eri_3_3_3_3

subroutine auto2e_eri_Spher_3_3_3_3(G, Ra, CntrA, ExpA, NprimA, &
Rb, CntrB, ExpB, NprimB, Rc, CntrC, ExpC, NprimC, &
Rd, CntrD, ExpD, NprimD, Kappa)
!
! Two-electron integrals class: (ff|ff)
...
call auto2e_W_6_6(W, Ra, CntrA, ExpA, NprimA, Rb, CntrB, ExpB, NprimB, &
   Rc, CntrC, ExpC, NprimC, Rd, CntrD, ExpD, NprimD, Kappa, 47, 47)
call auto2e_BraKetTransfer_Spher_3_3_3_3(G, W, Ra, Rb, Rc, Rd)
end subroutine auto2e_eri_Spher_3_3_3_3

subroutine auto2e_BraKetTransfer_3_3_3_3(G, W, Ra, Rb, Rc, Rd)
!
! Transform (LS|KS), L=3..6, K=3..6 using the horizontal recurrence relation
...
!
real(F64), dimension(100, *), intent(out) :: G
real(F64), dimension(74, 74), intent(in) :: W
real(F64), dimension(3), intent(in) :: Ra, Rb, Rc, Rd
real(F64), dimension(3) :: AB, CD
real(F64), dimension(74, 100) :: T
real(F64), dimension(100, 74) :: U
AB = Ra - Rb
CD = Rc - Rd
call auto2e_KetTransfer_3_3(T, W, CD(1), CD(2), CD(3))
U = transpose(T)
call auto2e_KetTransfer_3_3(G(:, 1:100), U, AB(1), AB(2), AB(3))
end subroutine auto2e_BraKetTransfer_3_3_3_3

subroutine auto2e_BraKetTransfer_Spher_3_3_3_3(G, W, Ra, Rb, Rc, Rd)
!
! Transform (LS|KS), L=3..6, K=3..6 using the horizontal recurrence relation
! of Eq. 18 in Head-Gordon, M. and Pople, J.A. J. Chem. Phys. 89, 5777 (1988);
! doi: 10.1063/1.455553
...
real(F64), dimension(3), intent(in) :: Ra, Rb, Rc, Rd
real(F64), dimension(3) :: AB, CD
real(F64), dimension(74, 100) :: Txyz
real(F64), dimension(74, 49) :: T
real(F64), dimension(49, 74) :: U
real(F64), dimension(49, 100) :: Gxyz
AB = Ra - Rb
CD = Rc - Rd
call auto2e_KetTransfer_3_3(Txyz, W, CD(1), CD(2), CD(3))
call auto2e_SpherTransf_U_Vector_3_3(T, Txyz, 74)
U = transpose(T)
call auto2e_KetTransfer_3_3(Gxyz, U, AB(1), AB(2), AB(3))
call auto2e_SpherTransf_U_Vector_3_3(G(:, 1:49), Gxyz, 49)
end subroutine auto2e_BraKetTransfer_Spher_3_3_3_3

subroutine auto2e_Normalize_3_3_3_3_DCBA(Gdcba, Gcdab, NormA, NormB, NormC, NormD)
!
...
end subroutine auto2e_Normalize_3_3_3_3_DCBA

subroutine auto2e_Normalize_Spher_3_3_3_3_DCBA(Gdcba, Gcdab, NormA, NormB, NormC, NormD)
!
! Apply L-dependent normalization constants and change the memory layout:
!
! Input memory layout: CDAB
...
end subroutine auto2e_Normalize_Spher_3_3_3_3_DCBA

subroutine auto2e_frontend_3_3_3_3(G, Ra, CntrA, NormA, ExpA, NprimA, &
...
integer, intent(in) :: NprimA, NprimB, NprimC, NprimD
real(F64), intent(in) :: Kappa
real(F64), dimension(10000) :: H
call auto2e_eri_3_3_3_3(H, Ra, CntrA, ExpA, NprimA, &
   Rb, CntrB, ExpB, NprimB, &
   Rc, CntrC, ExpC, NprimC, &
   Rd, CntrD, ExpD, NprimD, Kappa)
call auto2e_Normalize_3_3_3_3_DCBA(G, H, NormA, NormB, NormC, NormD)
end subroutine auto2e_frontend_3_3_3_3

subroutine auto2e_frontend_Spher_3_3_3_3(G, Ra, CntrA, NormA, ExpA, NprimA, &
Rb, CntrB, NormB, ExpB, NprimB, Rc, CntrC, NormC, ExpC, NprimC, &
Rd, CntrD, NormD, ExpD, NprimD, Kappa)
real(F64), dimension(*), intent(out) :: G
real(F64), dimension(3), intent(in) :: Ra, Rb, Rc, Rd
...
integer, intent(in) :: NprimA, NprimB, NprimC, NprimD
real(F64), intent(in) :: Kappa
real(F64), dimension(2401) :: H
call auto2e_eri_Spher_3_3_3_3(H, Ra, CntrA, ExpA, NprimA, &
   Rb, CntrB, ExpB, NprimB, &
   Rc, CntrC, ExpC, NprimC, &
   Rd, CntrD, ExpD, NprimD, Kappa)
call auto2e_Normalize_Spher_3_3_3_3_DCBA(G, H, NormA, NormB, NormC, NormD)
end subroutine auto2e_frontend_Spher_3_3_3_3
end module auto2e_eri_ffff