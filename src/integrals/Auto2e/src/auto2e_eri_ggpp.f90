...
! Angular momenta: A=4, B=4, C=1, and D=1
!
...
subroutine auto2e_eri_4_4_1_1(G, Ra, CntrA, ExpA, NprimA, &
Rb, CntrB, ExpB, NprimB, Rc, CntrC, ExpC, NprimC, &
Rd, CntrD, ExpD, NprimD, Kappa)
!
! Two-electron integrals class: (gg|pp)
...
real(F64), dimension(145, 9) :: W
!
! Compute (LS|KS) integrals, L=4..8 and K=1..2
!
W = ZERO
...
call auto2e_W_8_2(W, Ra, CntrA, ExpA, NprimA, Rb, CntrB, ExpB, NprimB, &
   Rc, CntrC, ExpC, NprimC, Rd, CntrD, ExpD, NprimD, Kappa, 101, 4)
call auto2e_BraKetTransfer_4_4_1_1(G, W, Ra, Rb, Rc, Rd)
end subroutine auto2e_eri_4_4_1_1

subroutine auto2e_eri_Spher_4_4_1_1(G, Ra, CntrA, ExpA, NprimA, &
Rb, CntrB, ExpB, NprimB, Rc, CntrC, ExpC, NprimC, &
Rd, CntrD, ExpD, NprimD, Kappa)
!
! Two-electron integrals class: (gg|pp)
...
call auto2e_W_8_2(W, Ra, CntrA, ExpA, NprimA, Rb, CntrB, ExpB, NprimB, &
   Rc, CntrC, ExpC, NprimC, Rd, CntrD, ExpD, NprimD, Kappa, 101, 4)
call auto2e_BraKetTransfer_Spher_4_4_1_1(G, W, Ra, Rb, Rc, Rd)
end subroutine auto2e_eri_Spher_4_4_1_1

subroutine auto2e_BraKetTransfer_4_4_1_1(G, W, Ra, Rb, Rc, Rd)
!
! Transform (LS|KS), L=4..8, K=1..2 using the horizontal recurrence relation
...
real(F64), dimension(145, 9), intent(in) :: W
real(F64), dimension(3), intent(in) :: Ra, Rb, Rc, Rd
...
end subroutine auto2e_BraKetTransfer_4_4_1_1

subroutine auto2e_BraKetTransfer_Spher_4_4_1_1(G, W, Ra, Rb, Rc, Rd)
!
! Transform (LS|KS), L=4..8, K=1..2 using the horizontal recurrence relation
! of Eq. 18 in Head-Gordon, M. and Pople, J.A. J. Chem. Phys. 89, 5777 (1988);
! doi: 10.1063/1.455553
...
end subroutine auto2e_BraKetTransfer_Spher_4_4_1_1

subroutine auto2e_Normalize_4_4_1_1_BADC(Gbadc, Gcdab, NormA, NormB, NormC, NormD)
!
...
end subroutine auto2e_Normalize_4_4_1_1_BADC

subroutine auto2e_Normalize_4_4_1_1_DCBA(Gdcba, Gcdab, NormA, NormB, NormC, NormD)
!
! Apply L-dependent normalization constants and change the memory layout:
!
! Input memory layout: CDAB
...
end subroutine auto2e_Normalize_4_4_1_1_DCBA

subroutine auto2e_Normalize_Spher_4_4_1_1_BADC(Gbadc, Gcdab, NormA, NormB, NormC, NormD)
!
! Apply L-dependent normalization constants and change the memory layout:
!
! Input memory layout: CDAB
...
end subroutine auto2e_Normalize_Spher_4_4_1_1_BADC

subroutine auto2e_Normalize_Spher_4_4_1_1_DCBA(Gdcba, Gcdab, NormA, NormB, NormC, NormD)
!
! Apply L-dependent normalization constants and change the memory layout:
!
! Input memory layout: CDAB
...
end subroutine auto2e_Normalize_Spher_4_4_1_1_DCBA

subroutine auto2e_frontend_1_1_4_4(G, Ra, CntrA, NormA, ExpA, NprimA, &
...
call auto2e_eri_4_4_1_1(H, Rc, CntrC, ExpC, NprimC, &
   Rd, CntrD, ExpD, NprimD, &
   Ra, CntrA, ExpA, NprimA, &
   Rb, CntrB, ExpB, NprimB, Kappa)
call auto2e_Normalize_4_4_1_1_BADC(G, H, NormC, NormD, NormA, NormB)
end subroutine auto2e_frontend_1_1_4_4

subroutine auto2e_frontend_Spher_1_1_4_4(G, Ra, CntrA, NormA, ExpA, NprimA, &
Rb, CntrB, NormB, ExpB, NprimB, Rc, CntrC, NormC, ExpC, NprimC, &
Rd, CntrD, NormD, ExpD, NprimD, Kappa)
real(F64), dimension(*), intent(out) :: G
real(F64), dimension(3), intent(in) :: Ra, Rb, Rc, Rd
...
call auto2e_eri_Spher_4_4_1_1(H, Rc, CntrC, ExpC, NprimC, &
   Rd, CntrD, ExpD, NprimD, &
   Ra, CntrA, ExpA, NprimA, &
   Rb, CntrB, ExpB, NprimB, Kappa)
call auto2e_Normalize_Spher_4_4_1_1_BADC(G, H, NormC, NormD, NormA, NormB)
end subroutine auto2e_frontend_Spher_1_1_4_4

subroutine auto2e_frontend_4_4_1_1(G, Ra, CntrA, NormA, ExpA, NprimA, &
Rb, CntrB, NormB, ExpB, NprimB, Rc, CntrC, NormC, ExpC, NprimC, &
Rd, CntrD, NormD, ExpD, NprimD, Kappa)
real(F64), dimension(*), intent(out) :: G
real(F64), dimension(3), intent(in) :: Ra, Rb, Rc, Rd
...
real(F64), intent(in) :: Kappa
real(F64), dimension(2025) :: H
call auto2e_eri_4_4_1_1(H, Ra, CntrA, ExpA, NprimA, &
   Rb, CntrB, ExpB, NprimB, &
   Rc, CntrC, ExpC, NprimC, &
   Rd, CntrD, ExpD, NprimD, Kappa)
call auto2e_Normalize_4_4_1_1_DCBA(G, H, NormA, NormB, NormC, NormD)
end subroutine auto2e_frontend_4_4_1_1

subroutine auto2e_frontend_Spher_4_4_1_1(G, Ra, CntrA, NormA, ExpA, NprimA, &
Rb, CntrB, NormB, ExpB, NprimB, Rc, CntrC, NormC, ExpC, NprimC, &
Rd, CntrD, NormD, ExpD, NprimD, Kappa)
real(F64), dimension(*), intent(out) :: G
real(F64), dimension(3), intent(in) :: Ra, Rb, Rc, Rd
...
real(F64), intent(in) :: Kappa
real(F64), dimension(729) :: H
call auto2e_eri_Spher_4_4_1_1(H, Ra, CntrA, ExpA, NprimA, &
   Rb, CntrB, ExpB, NprimB, &
   Rc, CntrC, ExpC, NprimC, &
   Rd, CntrD, ExpD, NprimD, Kappa)
call auto2e_Normalize_Spher_4_4_1_1_DCBA(G, H, NormA, NormB, NormC, NormD)
end subroutine auto2e_frontend_Spher_4_4_1_1
end module auto2e_eri_ggpp