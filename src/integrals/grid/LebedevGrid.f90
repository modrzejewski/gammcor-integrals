module LebedevGrid
      ...
      !
      ! --------------------------------------------
      !        Lebedev spherical grids
      !
      ! Note that some quadratures have negative
      ! weights, e.g., those for Lmax=13, 25, 27.
      ! --------------------------------------------
      ! Lmax       Number of points   Subroutine
      !                               Pointer
      ! --------------------------------------------
      !   3                       6   1
      !   5                      14   2
      ...
      !  53                     974   19
      !  59                    1202   20
      !  65                    1454   21 -- max grid available via a subroutine pointer --
      !  71                    1730
      !  77                    2030
      !  83                    2354
      !  89                    2702
      ...
      ! 131                    5810
      !
      integer, parameter :: LEBEDEV_NGRIDS = 21 ! Number of grids available via the subroutine pointer interface
      integer, parameter :: LEBEDEV_LMIN = 3 ! L for the smallest grid
      integer, parameter :: LEBEDEV_LMAX =  65 ! L for the largest grid available via the subroutine pointer interface

      type TLebedevGrid
            procedure(lebedev_0006), pointer, nopass :: ptr
            integer :: Lmax
            integer :: NPoints
      ...
      end type TLebedevGrid

contains

      subroutine lebedev_init(LebedevGrids, LebedevLMap)
            type(TLebedevGrid), dimension(LEBEDEV_NGRIDS), intent(out) :: LebedevGrids
            integer, dimension(LEBEDEV_LMAX), intent(out) :: LebedevLMap

            integer :: k, l
            integer :: Lmax, LmaxPrev
            integer :: NPoints, N
            ! --------------------------------
            !   3                       6   1
            LebedevGrids(1)%ptr => lebedev_0006
            LebedevGrids(1)%Lmax = 3
            LebedevGrids(1)%NPoints = 6            
            ! --------------------------------
            !   5                      14   2
            LebedevGrids(2)%ptr => lebedev_0014
            LebedevGrids(2)%Lmax = 5
            LebedevGrids(2)%NPoints = 14
            ! --------------------------------
            !   7                      26   3
            LebedevGrids(3)%ptr => lebedev_0026
            LebedevGrids(3)%Lmax = 7
            LebedevGrids(3)%NPoints = 26
            ! --------------------------------
            !   9                      38   4
            LebedevGrids(4)%ptr => lebedev_0038
            LebedevGrids(4)%Lmax = 9
            LebedevGrids(4)%NPoints = 38
            ! --------------------------------
            !  11                      50   5            
            LebedevGrids(5)%ptr => lebedev_0050
            LebedevGrids(5)%Lmax = 11
            LebedevGrids(5)%NPoints = 50
            ! --------------------------------
            !  13                      74   6
            LebedevGrids(6)%ptr => lebedev_0074
            LebedevGrids(6)%Lmax = 13
            LebedevGrids(6)%NPoints = 74
            ! --------------------------------
            !  15                      86   7
            LebedevGrids(7)%ptr => lebedev_0086
            LebedevGrids(7)%Lmax = 15
            LebedevGrids(7)%NPoints = 86
            ! --------------------------------
            !  17                     110   8
            LebedevGrids(8)%ptr => lebedev_0110
            LebedevGrids(8)%Lmax = 17
            LebedevGrids(8)%NPoints = 110
            ! --------------------------------
            !  19                     146   9
            LebedevGrids(9)%ptr => lebedev_0146
            LebedevGrids(9)%Lmax = 19
            LebedevGrids(9)%NPoints = 146
            ! --------------------------------
            !  21                     170   10
            LebedevGrids(10)%ptr => lebedev_0170
            LebedevGrids(10)%Lmax = 21
            LebedevGrids(10)%NPoints = 170
            ! ---------------------------------
            !  23                     194   11
            LebedevGrids(11)%ptr => lebedev_0194
            LebedevGrids(11)%Lmax = 23
            LebedevGrids(11)%NPoints = 194
            ! ---------------------------------
            !  25                     230   12
            LebedevGrids(12)%ptr => lebedev_0230
            LebedevGrids(12)%Lmax = 25
            LebedevGrids(12)%NPoints = 230
            ! ---------------------------------
            !  27                     266   13
            LebedevGrids(13)%ptr => lebedev_0266
            LebedevGrids(13)%Lmax = 27
            LebedevGrids(13)%NPoints = 266
            ! ---------------------------------
            !  29                     302   14
            LebedevGrids(14)%ptr => lebedev_0302
            LebedevGrids(14)%Lmax = 29
            LebedevGrids(14)%NPoints = 302
            ! ---------------------------------
            !  31                     350   15
            LebedevGrids(15)%ptr => lebedev_0350
            LebedevGrids(15)%Lmax = 31
            LebedevGrids(15)%NPoints = 350
            ! ---------------------------------
            !  35                     434   16
            LebedevGrids(16)%ptr => lebedev_0434
            LebedevGrids(16)%Lmax = 35
            LebedevGrids(16)%NPoints = 434
            ! ---------------------------------
            !  41                     590   17
            LebedevGrids(17)%ptr => lebedev_0590
            LebedevGrids(17)%Lmax = 41
            LebedevGrids(17)%NPoints = 590
            ! ---------------------------------
            !  47                     770   18
            LebedevGrids(18)%ptr => lebedev_0770
            LebedevGrids(18)%Lmax = 47
            LebedevGrids(18)%NPoints = 770
            ! ---------------------------------
            !  53                     974   19
            LebedevGrids(19)%ptr => lebedev_0974
            LebedevGrids(19)%Lmax = 53
            LebedevGrids(19)%NPoints = 974
            ! ---------------------------------
            !  59                    1202   20
            LebedevGrids(20)%ptr => lebedev_1202
            LebedevGrids(20)%Lmax = 59
            LebedevGrids(20)%NPoints = 1202
            ! ---------------------------------
            !  65                    1454   21
            LebedevGrids(21)%ptr => lebedev_1454
            LebedevGrids(21)%Lmax = 65
            LebedevGrids(21)%NPoints = 1454

            LmaxPrev = 0            
            do k = 1, LEBEDEV_NGRIDS
                  Lmax = LebedevGrids(k)%Lmax
                  do l = LmaxPrev + 1, Lmax
                        LebedevLMap(l) = k
                  end do
                  LmaxPrev = Lmax
            end do
            ...
            do k = 1, LEBEDEV_NGRIDS
                  NPoints = LebedevGrids(k)%NPoints
                  allocate(LebedevGrids(k)%x(NPoints))
                  allocate(LebedevGrids(k)%y(NPoints))
                  allocate(LebedevGrids(k)%z(NPoints))
                  allocate(LebedevGrids(k)%w(NPoints))
                  call LebedevGrids(k)%ptr(LebedevGrids(k)%x, &
                        LebedevGrids(k)%y, LebedevGrids(k)%z, &
                        LebedevGrids(k)%w, N)
                  if (N /= NPoints) then
                        call msg("Invalid parameters of the Lebedev quadrature", MSG_ERROR)
                        error stop
                  end if
            end do
      end subroutine lebedev_init


      subroutine lebedev_gen_oh(code, num, x, y, z, w, a, b, v)
...
6           continue
            ...
            num=num+48
            return
      end subroutine lebedev_gen_oh
      SUBROUTINE LEBEDEV_0006(X,Y,Z,W,N)
            REAL(F64) :: X(*)
            REAL(F64) :: Y(*)
            REAL(F64) :: Z(*)
            REAL(F64) :: W(*)
            ...
            Call Lebedev_Gen_Oh( 1, N, X(N), Y(N), Z(N), W(N), A, B, V)
            N=N-1

            RETURN
      END SUBROUTINE LEBEDEV_0006
      SUBROUTINE LEBEDEV_0014(X,Y,Z,W,N)
            REAL(F64) :: X(*)
            REAL(F64) :: Y(*)
            REAL(F64) :: Z(*)
            REAL(F64) :: W(*)
            ...
            Call Lebedev_Gen_Oh( 3, N, X(N), Y(N), Z(N), W(N), A, B, V)
            N=N-1
            RETURN
      END SUBROUTINE LEBEDEV_0014
      SUBROUTINE LEBEDEV_0026(X,Y,Z,W,N)
            REAL(F64) :: X(*)
            REAL(F64) :: Y(*)
            REAL(F64) :: Z(*)
            REAL(F64) :: W(*)
            ...
            Call Lebedev_Gen_Oh( 2, N, X(N), Y(N), Z(N), W(N), A, B, V)
            V=0.3214285714285714D-1
            Call Lebedev_Gen_Oh( 3, N, X(N), Y(N), Z(N), W(N), A, B, V)
            N=N-1
            RETURN
      END SUBROUTINE LEBEDEV_0026
      SUBROUTINE LEBEDEV_0038(X,Y,Z,W,N)
            REAL(F64) :: X(*)
            REAL(F64) :: Y(*)
            REAL(F64) :: Z(*)
            REAL(F64) :: W(*)
            ...
            Call Lebedev_Gen_Oh( 5, N, X(N), Y(N), Z(N), W(N), A, B, V)
            N=N-1
            RETURN
      END SUBROUTINE LEBEDEV_0038
      SUBROUTINE LEBEDEV_0050(X,Y,Z,W,N)
            REAL(F64) :: X(*)
            REAL(F64) :: Y(*)
            REAL(F64) :: Z(*)
            REAL(F64) :: W(*)
            ...
            Call Lebedev_Gen_Oh( 4, N, X(N), Y(N), Z(N), W(N), A, B, V)
            N=N-1
            RETURN
      END SUBROUTINE LEBEDEV_0050
      SUBROUTINE LEBEDEV_0074(X,Y,Z,W,N)
            REAL(F64) :: X(*)
            REAL(F64) :: Y(*)
            REAL(F64) :: Z(*)
            REAL(F64) :: W(*)
            ...
            N=N-1
            RETURN
      END SUBROUTINE LEBEDEV_0074
      SUBROUTINE LEBEDEV_0086(X,Y,Z,W,N)
            REAL(F64) :: X(*)
            REAL(F64) :: Y(*)
            REAL(F64) :: Z(*)
            REAL(F64) :: W(*)
            ...
            N=N-1
            RETURN
      END SUBROUTINE LEBEDEV_0086
      SUBROUTINE LEBEDEV_0110(X,Y,Z,W,N)
            REAL(F64) :: X(*)
            REAL(F64) :: Y(*)
            REAL(F64) :: Z(*)
            REAL(F64) :: W(*)
            ...
            N=N-1
            RETURN
      END SUBROUTINE LEBEDEV_0110
      SUBROUTINE LEBEDEV_0146(X,Y,Z,W,N)
            REAL(F64) :: X(*)
            REAL(F64) :: Y(*)
            REAL(F64) :: Z(*)
            REAL(F64) :: W(*)
            ...
            Call Lebedev_Gen_Oh( 6, N, X(N), Y(N), Z(N), W(N), A, B, V)
            N=N-1
            RETURN
      END SUBROUTINE LEBEDEV_0146
      SUBROUTINE LEBEDEV_0170(X,Y,Z,W,N)
            REAL(F64) :: X(*)
            REAL(F64) :: Y(*)
            REAL(F64) :: Z(*)
            REAL(F64) :: W(*)
            ...
            N=N-1
            RETURN
      END SUBROUTINE LEBEDEV_0170
      SUBROUTINE LEBEDEV_0194(X,Y,Z,W,N)
            REAL(F64) :: X(*)
            REAL(F64) :: Y(*)
            REAL(F64) :: Z(*)
            REAL(F64) :: W(*)
            ...
            N=N-1
            RETURN
      END SUBROUTINE LEBEDEV_0194
      SUBROUTINE LEBEDEV_0230(X,Y,Z,W,N)
            REAL(F64) :: X(*)
            REAL(F64) :: Y(*)
            REAL(F64) :: Z(*)
            REAL(F64) :: W(*)
            ...
            N=N-1
            RETURN
      END SUBROUTINE LEBEDEV_0230
      SUBROUTINE LEBEDEV_0266(X,Y,Z,W,N)
            REAL(F64) :: X(*)
            REAL(F64) :: Y(*)
            REAL(F64) :: Z(*)
            REAL(F64) :: W(*)
            ...
            N=N-1
            RETURN
      END SUBROUTINE LEBEDEV_0266
      SUBROUTINE LEBEDEV_0302(X,Y,Z,W,N)
            REAL(F64) :: X(*)
            REAL(F64) :: Y(*)
            REAL(F64) :: Z(*)
            REAL(F64) :: W(*)
            ...
            N=N-1
            RETURN
      END SUBROUTINE LEBEDEV_0302
      SUBROUTINE LEBEDEV_0350(X,Y,Z,W,N)
            REAL(F64) :: X(*)
            REAL(F64) :: Y(*)
            REAL(F64) :: Z(*)
            REAL(F64) :: W(*)
            ...
            N=N-1
            RETURN
      END SUBROUTINE LEBEDEV_0350
      SUBROUTINE LEBEDEV_0434(X,Y,Z,W,N)
            REAL(F64) :: X(*)
            REAL(F64) :: Y(*)
            REAL(F64) :: Z(*)
            REAL(F64) :: W(*)
            ...
            N=N-1
            RETURN
      END SUBROUTINE LEBEDEV_0434
      SUBROUTINE LEBEDEV_0590(X,Y,Z,W,N)
            REAL(F64) :: X(*)
            REAL(F64) :: Y(*)
            REAL(F64) :: Z(*)
            REAL(F64) :: W(*)
            ...
            N=N-1
            RETURN
      END SUBROUTINE LEBEDEV_0590
      SUBROUTINE LEBEDEV_0770(X,Y,Z,W,N)
            REAL(F64) :: X(*)
            REAL(F64) :: Y(*)
            REAL(F64) :: Z(*)
            REAL(F64) :: W(*)
            ...
            N=N-1
            RETURN
      END SUBROUTINE LEBEDEV_0770
      SUBROUTINE LEBEDEV_0974(X,Y,Z,W,N)
            REAL(F64) :: X(*)
            REAL(F64) :: Y(*)
            REAL(F64) :: Z(*)
            REAL(F64) :: W(*)
            ...
            N=N-1
            RETURN
      END SUBROUTINE LEBEDEV_0974
      SUBROUTINE lebedev_1202(X,Y,Z,W,N)
            REAL(F64) :: X(*)
            REAL(F64) :: Y(*)
            REAL(F64) :: Z(*)
            REAL(F64) :: W(*)
            ...
            N=N-1
            RETURN
      END SUBROUTINE lebedev_1202
      SUBROUTINE lebedev_1454(X,Y,Z,W,N)
            REAL(F64) :: X(*)
            REAL(F64) :: Y(*)
            REAL(F64) :: Z(*)
            REAL(F64) :: W(*)
            ...
            N=N-1
            RETURN
      END SUBROUTINE lebedev_1454
      SUBROUTINE lebedev_1730(X,Y,Z,W,N)
            REAL(F64) :: X(*)
            REAL(F64) :: Y(*)
            REAL(F64) :: Z(*)
            REAL(F64) :: W(*)
            ...
            N=N-1
            RETURN
      END SUBROUTINE lebedev_1730
      SUBROUTINE lebedev_2030(X,Y,Z,W,N)
            REAL(F64) :: X(*)
            REAL(F64) :: Y(*)
            REAL(F64) :: Z(*)
            REAL(F64) :: W(*)
            ...
            N=N-1
            RETURN
      END SUBROUTINE lebedev_2030
      SUBROUTINE lebedev_2354(X,Y,Z,W,N)
            REAL(F64) :: X(*)
            REAL(F64) :: Y(*)
            REAL(F64) :: Z(*)
            REAL(F64) :: W(*)
            ...
            N=N-1
            RETURN
      END SUBROUTINE lebedev_2354
      SUBROUTINE lebedev_2702(X,Y,Z,W,N)
            REAL(F64) :: X(*)
            REAL(F64) :: Y(*)
            REAL(F64) :: Z(*)
            REAL(F64) :: W(*)
            ...
            N=N-1
            RETURN
      END SUBROUTINE lebedev_2702
      SUBROUTINE lebedev_3074(X,Y,Z,W,N)
            REAL(F64) :: X(*)
            REAL(F64) :: Y(*)
            REAL(F64) :: Z(*)
            REAL(F64) :: W(*)
            ...
            N=N-1
            RETURN
      END SUBROUTINE lebedev_3074
      SUBROUTINE lebedev_3470(X,Y,Z,W,N)
            REAL(F64) :: X(*)
            REAL(F64) :: Y(*)
            REAL(F64) :: Z(*)
            REAL(F64) :: W(*)
            ...
            N=N-1
            RETURN
      END SUBROUTINE lebedev_3470
      SUBROUTINE lebedev_3890(X,Y,Z,W,N)
            REAL(F64) :: X(*)
            REAL(F64) :: Y(*)
            REAL(F64) :: Z(*)
            REAL(F64) :: W(*)
            ...
            N=N-1
            RETURN
      END SUBROUTINE lebedev_3890
      SUBROUTINE LEBEDEV_4334(X,Y,Z,W,N)
            REAL(F64) :: X(*)
            REAL(F64) :: Y(*)
            REAL(F64) :: Z(*)
            REAL(F64) :: W(*)
            ...
            N=N-1
            RETURN
      END SUBROUTINE LEBEDEV_4334
      SUBROUTINE LEBEDEV_4802(X,Y,Z,W,N)
            REAL(F64) :: X(*)
            REAL(F64) :: Y(*)
            REAL(F64) :: Z(*)
            REAL(F64) :: W(*)
            ...
            N=N-1
            RETURN
      END SUBROUTINE LEBEDEV_4802
      SUBROUTINE LEBEDEV_5294(X,Y,Z,W,N)
            REAL(F64) :: X(*)
            REAL(F64) :: Y(*)
            REAL(F64) :: Z(*)
            REAL(F64) :: W(*)
            ...
            N=N-1
            RETURN
      END SUBROUTINE LEBEDEV_5294
      SUBROUTINE LEBEDEV_5810(X,Y,Z,W,N)
            REAL(F64) :: X(*)
            REAL(F64) :: Y(*)
            REAL(F64) :: Z(*)
            REAL(F64) :: W(*)
            ...
            N=N-1
            RETURN
      END SUBROUTINE LEBEDEV_5810
end module LebedevGrid
